...
def min_reduction_over_a_dimension_impl_npu(gm_input, gm_output):
    ...
    for i in range(SAMPLES_PER_CORE):
        ...
        max_fp16 = Scalar("FP16", 65504)
        ub_output = vector_dup(max_fp16, [1, DIM2], False)
...
def min_reduction_over_a_dimension_host_run():
    ...
    min_reduction_over_a_dimension_impl_npu(gm_input, gm_output)
