...
from tests.common.test_run.ascend.add_ad_run import add_ad_run
...
class TestCase(TestBase):
    ...
    def setup(self):
        ...
        self.testarg = [
            ...
            ("add_1_1_int32", add_ad_run, ([1], [1], "int32", "cce_add_int32")),
            ("add_2_1_int32", add_ad_run, ([2], [1], "int32", "cce_add_int32")),
            ("001_add_2_2_fp16", add_ad_run, ([2], [2], "float16", "cce_add_fp16", 3.0)),
            ("001b_add_2_2_fp16", add_ad_run, ([2], [2], "float16", "cce_add_fp16", 2.0)),
            ("002_add_1024_1024_fp16", add_ad_run, ([1024], [1024], "float16", "cce_add_fp16")),
            ("003_add_4096_4096_fp16", add_ad_run, ([4096], [4096], "float16", "cce_add_fp16")),
            ("004_add_30522_30522_fp16", add_ad_run, ([30522], [30522], "float16", "cce_add_fp16")),
            ("005_add_2_1024_2_1024_fp16", add_ad_run, ([2, 1024], [2, 1024], "float16", "cce_add_fp16")),
            ("006_add_160_1024_160_1024_fp16", add_ad_run, ([160, 1024], [160, 1024], "float16", "cce_add_fp16")),
            ("007_add_512_1024_512_1024_fp16", add_ad_run, ([512, 1024], [512, 1024], "float16", "cce_add_fp16")),
            ("008_add_1024_1024_1024_1024_fp16", add_ad_run, ([1024, 1024], [1024, 1024], "float16", "cce_add_fp16")),
            ("009_add_1280_1024_1280_1024_fp16", add_ad_run, ([1280, 1024], [1280, 1024], "float16", "cce_add_fp16")),
            ("010_add_4096_1024_4096_1024_fp16", add_ad_run, ([4096, 1024], [4096, 1024], "float16", "cce_add_fp16")),
            ("011_add_4096_1024_4096_1024_fp16", add_ad_run, ([4096, 1024], [4096, 1024], "float16", "cce_add_fp16")),
            # manual scheduling tests, man sch work for all the shapes but including only two tests in the CI
            ########("012_add_2_2_fp16",                        add_ad_run, ([2], [2],                        "float16", "cce_add_fp16", 3.0), ([2, 2],), False),
            ########("013_add_160_1024_160_1024_fp16",          add_ad_run, ([160,1024], [160,1024],          "float16", "cce_add_fp16", 1.0), ([16, 16],[1024,1024]), False),
            ########("014_add_160_1024_160_1024_fp16",          add_ad_run, ([160,1024], [160,1024],          "float16", "cce_add_fp16"), ([20, 20],[1024,1024]), False),

            # deeplabv3
            ("add", add_ad_run, ([1, 1, 192, 64], [1], "float32", "cce_add_fp32")),
            #("add",                                     add_ad_run, ([576, 750, 1], [1],              "int32",   "cce_add_int32")),
        ]
        self.testarg_level1 = [
            #testflag,opfuncname,testRunArgs, dimArgs
            ...
            ####("114_add_4096_1_fp16",                     add_run, ([4096], [1],                     "float16", "cce_add_fp16")),
            ...
            ####("118_add_1280_1_1_fp16",                   add_run, ([1280,1], [1],                   "float16", "cce_add_fp16")),
            ...
            ####("124_add_1024_4096_1_fp16",                add_run, ([1024,4096], [1],                "float16", "cce_add_fp16")),
            ...
            ####("132_add_1_8192_4096_fp16",                add_run, ([1], [8192,4096],                "float16", "cce_add_fp16")),
            ...
            ####("add",                                     add_run, ([830, 1000, 1], [1],            "int32",   "cce_add_int32")),
            ####("add",                                     add_run, ([627, 750, 1], [1],             "int32",   "cce_add_int32")),
            ####("add",                                     add_run, ([656, 875, 1], [1],             "int32",   "cce_add_int32")),
            ####("add",                                     add_run, ([750, 513, 1], [1, 1, 3],       "int32",   "cce_add_int32")),
            ####("add",                                     add_run, ([666, 1000, 1], [1],            "int32",   "cce_add_int32")),
            ####("add",                                     add_run, ([1000, 750, 1], [1],            "int32",   "cce_add_int32")),
            ####("add",                                     add_run, ([562, 750, 1], [1],             "int32",   "cce_add_int32")),
        ]
        return
