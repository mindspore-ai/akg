...
"""
matmul mul trans data fusion
"""
import os
import pytest
from tests.common.base import TestBase, get_splitted_cases
from tests.common.test_run.ascend.matmul_mul_transdata_run import matmul_mul_transdata_execute


class TestCase(TestBase):

    def setup(self):
        case_name = "test_akg_matmul_mul_transdata_001"
        case_path = os.getcwd()
        ...
        self.testarg = [
            ...
            ("matmul_0", matmul_mul_transdata_execute, ((4096, 768), (4096, 12288), 0, "scalar", "zN", "zN", "zN", True, False, "float16", None, "float32", "matmul_mul_transdata_cce")),
            ("matmul_1", matmul_mul_transdata_execute, ((4096, 768), (12288, 768), 0, "scalar", "zN", "zN", "zN", False, True, "float16", None, "float16", "matmul_mul_transdata_cce")),
        ]
