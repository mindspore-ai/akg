...
from tests.common.test_run.ascend.matmul_transdata_run import matmul_transdata_execute
...
class TestCase(TestBase):
    ...
    def setup(self):
        ...
        self.testarg = [
            ...
            ("matmul_0", matmul_transdata_execute, ((4096, 768), (4096, 12288), 0, "zN", "zN", "zN", True, False, "float16", None, "float32", "matmul_transdata_cce")),
            ("matmul_1", matmul_transdata_execute, ((4096, 768), (12288, 768), 0, "zN", "zN", "zN", False, True, "float16", None, "float16", "matmul_transdata_cce")),
        ]
