...
from tests.common.test_run import sub_run
...
class TestCase(TestBase):
    def setup(self):
        ...
        self.args_default = [
            ("000_case", sub_run, ((32, 1024, 1024), (32, 1024, 1024), "float16"), ["level0"]),
            ("000_case", sub_run, ((32, 1024, 1024), (1, 1024, 1024), "float32"), ["level0"]),
            ("000_case", sub_run, ((4, 4, 4), (1, 4, 4), "float32"), ["level0"]),
        ]
        return True
