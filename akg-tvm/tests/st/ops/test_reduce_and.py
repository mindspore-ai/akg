...
from tests.common.test_run import reduce_and_run
...
class TestCase(TestBase):
    def setup(self):
        ...
        self.testarg = [
            ...
            ("000_case", reduce_and_run, ((32786,), "bool", None, True), ["level0"]),
            ("001_case", reduce_and_run, ((1024, 1024), "bool", (1,), True), ["level0"]),
        ]
        return True
