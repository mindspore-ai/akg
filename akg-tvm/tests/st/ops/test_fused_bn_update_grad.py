...
from tests.common.test_run import fused_bn_update_grad_run
...
class TestCase(TestBase):
    def setup(self):
        case_name = "fused_bn_update_grad"
        case_path = os.getcwd()

        self.params_init(case_name, case_path)

        self.args_default = [
            ("000_case", fused_bn_update_grad_run, ((32, 7, 7, 32), (32,), "float16", "float32", "NHWC"), ["level0"]),
        ]
        return True
