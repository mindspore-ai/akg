...
from tests.common.test_op.gpu import fused_gather_nd_reduce_sum_mul_unsorted_segment_sum
...
def fused_gather_nd_reduce_sum_mul_unsorted_segment_sum_run(
    ...
    if attrs["profiling"]:
        ...
        target_profiling(mod, input1, input2, input3, input4, input5, output1, output2, target=target_name, repeat_time=attrs["repeat_times"])
    return (input1, input2, input3, input4, input5), (output1, output2), (expect1, expect2), res