...
from akg.ops.array.ascend import StridedSlice
from akg.ops.array.ascend.strided_slice import args_to_slices
...
def strided_slice_compile(shape, begin, end, strides, begin_mask, end_mask, ellipsis_mask, new_axis_mask,
    ...
    return utils.op_build_test(StridedSlice, [shape], [dtype],
