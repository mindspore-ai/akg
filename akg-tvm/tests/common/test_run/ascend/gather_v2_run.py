...
from akg.ops.array.ascend import GatherV2
...
def gather_v2_run(shape1, dtype1, shape2, dtype2, axis, attrs):
    op_attrs = [axis]
    mod = utils.op_build_test(GatherV2, [shape1, shape2], [dtype1, dtype2], op_attrs=op_attrs, kernel_name="gather_v2", attrs=attrs)
