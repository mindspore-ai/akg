...
from tests.common.test_op.ascend.elemwise_sum import elemwise_sum
from tests.common.test_op.ascend.elemwise_sum import elemwise_sum_manual_schedule
from tests.common.tensorio import compare_tensor
from tests.common.gen_random import random_gaussian

def elemwise_sum_run(shape, dtype, attrs_op={}, polyhedral=True, attrs={}):
