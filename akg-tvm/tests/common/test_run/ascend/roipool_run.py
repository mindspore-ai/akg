...
from tests.common.test_op.ascend import roipool
from tests.common.tensorio import compare_tensor
from tests.common.gen_random import random_gaussian

def roipool_run(shape, roibox, pooled_shape, dtype, attrs_op={}, cce_path="./", attrs={}):
...
def roipool_expect(input_, shape, roibox, pooled_shape):
    dtype = [shape[0], shape[1], pooled_shape[0], pooled_shape[1]]
