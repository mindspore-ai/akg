...
from tests.common.test_op.ascend.pooling import pooling
from tests.common.test_run.ascend.maxpool_run import gen_data as maxpool_gen_data
from tests.common.test_run.ascend.avgpool_run import gen_data as avgpool_gen_data
