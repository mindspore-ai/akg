...
"""operator dsl function: crossentropyloss_ad"""
import akg
from tests.common.test_op.ascend import crossentropyloss

def crossentropyloss_ad(head, labels, logits, target="cce"):
