...
import akg
from tests.common.test_op.ascend.lstm_rnn import lstmcell, rnn_tanh_cell, rnn_relu_cell


def lstmcell_h_ad(_input, hx, cx, w_ih, w_hh, b_ih, b_hh, Head, input_id, target="cce"):
...
def lstmcell_c_ad(_input, hx, cx, w_ih, w_hh, b_ih, b_hh, Head, input_id, target="cce"):
...
def rnncell_tanh_ad(inputs, hidden, w_ih, w_hh, b_ih, b_hh, Head, input_id, target="cce"):
...
def rnncell_relu_ad(inputs, hidden, w_ih, w_hh, b_ih, b_hh, Head, input_id, target="cce"):
