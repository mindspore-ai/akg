...
"""operator dsl function: elemwise_sum_ad"""
import akg.tvm
import akg
...
def elemwise_sum_ad_set_dim_func(head, a, a2):
    key = []
...
@ct_util.reg_set_dim_func(elemwise_sum_ad_set_dim_func)
def elemwise_sum_ad(head, a, a2, target="cce"):
