...
def bc_test(first_input, second_input, third_input, target=utils.CCE):
    ...
    C = (A + C) + (A - C) + (B + C) + (A + B)
    """
    utils.check_shape(first_input)
    utils.check_shape(second_input)
    utils.check_shape(third_input)
