...
class Type : public NodeRef {
 public:
  Type() {}
  explicit Type(ObjectPtr<air::Object> p) : NodeRef(p) {}
...
class TensorTypeNode : public BaseTensorTypeNode {
 public:
   ...
   *  represented by IndexExpr(air::Expr).
   */
...
class TypeCallNode : public TypeNode {
 public:
  ...
  TVM_DLL static TypeCall make(Type func, air::Array<Type> args);
...
class FuncTypeNode : public TypeNode {
 public:
   ...
   */
  air::Array<TypeConstraint> type_constraints;
  ...
  TVM_DLL static FuncType make(air::Array<Type> arg_types,
                               Type ret_type,
                               air::Array<TypeVar> type_params,
                               air::Array<TypeConstraint> type_constraints);
...
class TupleTypeNode : public TypeNode {
 public:
  ...
  TVM_DLL static TupleType make(air::Array<Type> fields);
...
class TypeReporter : public NodeRef {
 public:
  TypeReporter() {}
  explicit TypeReporter(::air::ObjectPtr<::air::Object> n) : NodeRef(n) {
  }
