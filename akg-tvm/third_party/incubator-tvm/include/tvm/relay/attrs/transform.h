...
struct CastAttrs : public air::AttrsNode<CastAttrs> {
  DataType dtype;
...
struct ExpandDimsAttrs : public air::AttrsNode<ExpandDimsAttrs> {
  int axis;
  int num_newaxis;
...
struct ConcatenateAttrs : public air::AttrsNode<ConcatenateAttrs> {
  int axis;
...
struct TransposeAttrs : public air::AttrsNode<TransposeAttrs> {
  Array<Integer> axes;
...
struct ReshapeAttrs : public air::AttrsNode<ReshapeAttrs> {
...
struct TakeAttrs : public air::AttrsNode<TakeAttrs> {
  Integer axis;
  std::string mode;
...
struct InitOpAttrs : public air::AttrsNode<InitOpAttrs> {
...
struct ArangeAttrs : public air::AttrsNode<ArangeAttrs> {
  Expr start;
  Expr stop;
  Expr step;
  DataType dtype;
...
struct StackAttrs : public air::AttrsNode<StackAttrs> {
  Integer axis;
...
struct RepeatAttrs : public air::AttrsNode<RepeatAttrs> {
  Integer repeats;
  Integer axis;
...
struct TileAttrs : public air::AttrsNode<TileAttrs> {
  Array<Integer> reps;
...
struct ReverseAttrs : public air::AttrsNode<ReverseAttrs> {
  Integer axis;
...
struct SqueezeAttrs : public air::AttrsNode<SqueezeAttrs> {
...
struct SplitAttrs : public air::AttrsNode<SplitAttrs> {
...
struct StridedSliceAttrs : public air::AttrsNode<StridedSliceAttrs> {
  Array<Integer> begin;
  Array<Integer> end;
...
struct SliceLikeAttrs : public air::AttrsNode<SliceLikeAttrs> {
  Array<Integer> axes;
...
struct ClipAttrs : public air::AttrsNode<ClipAttrs> {
  double a_min;
  double a_max;
...
struct LayoutTransformAttrs : public air::AttrsNode<LayoutTransformAttrs> {
...
struct ShapeOfAttrs : public air::AttrsNode<ShapeOfAttrs> {
  DataType dtype;
...
struct SequenceMaskAttrs : public air::AttrsNode<SequenceMaskAttrs> {
  double mask_value;
  int axis;
...
struct NdarraySizeAttrs : public air::AttrsNode<NdarraySizeAttrs> {
  DataType dtype;
...
struct OneHotAttrs : public air::AttrsNode<OneHotAttrs> {
  int depth;
  int axis;
  DataType dtype;
...
struct ArgWhereAttrs : public air::AttrsNode<ArgWhereAttrs> {
