...
# - TVM_LLVM_VERSION
#
macro(find_llvm_macro)
  set(_llvm_priority_version "12")
  find_package(LLVM ${_llvm_priority_version} QUIET)
  if(NOT LLVM_FOUND)
    message(WARNING "Not found LLVM version ${_llvm_priority_version}. Try to find other version...")
...
macro(find_llvm use_llvm)
  ...
  if(LLVM_CONFIG STREQUAL "ON")
    ...
    if(NOT LLVM_FOUND)
      message(FATAL_ERROR "LLVM not found, please ensure that llvm 12.0.1 is installed.")
    endif()
  ...
  if(NOT LLVM_LIBS)
    ...
    # ignore 'libPollyISL.a' lib, which conflicts with symbols of ISL library used in polyhedral schedule
    string(REGEX REPLACE "[ ]+[^ ]+libPollyISL\.[^ ][ ]+" " " __llvm_libfiles ${__llvm_libfiles})
