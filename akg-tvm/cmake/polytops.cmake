...
if (AKG_USE_POLYTOPS)
  ...
  add_custom_target(akg-untar-polytops
    ALL
    COMMAND
      "${CMAKE_COMMAND}" -E tar xfz ${AKG_TVM_SOURCE_DIR}/prebuild/${AKG_POLYTOPS_ARCH}/libpolytops.tar.gz
    WORKING_DIRECTORY
      "${CMAKE_CURRENT_BINARY_DIR}/"
    DEPENDS
      "${AKG_TVM_SOURCE_DIR}/prebuild/${AKG_POLYTOPS_ARCH}/libpolytops.tar.gz"
  )
