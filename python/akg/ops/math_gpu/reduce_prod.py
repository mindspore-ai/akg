...
def reduce_prod(inputs, axis=None, keepdims=False):
    """
    Compute the prod of elements across dimensions of a tensor.
    ...
    output = akg.topi.prod(inputs, axis=axis, keepdims=keepdims)
