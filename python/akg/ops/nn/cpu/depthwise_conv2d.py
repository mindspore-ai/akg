...
"""operator dsl function: depthwise_conv2d"""
...
def depthwise_conv2d_nchwc(data, weight, stride, pad, dilation,
    ...
    if len(data.shape) == 4:
        ...
        out_channel, channel_multiplier, k_h, k_w = get_const_tuple(
            weight.shape)
        ...
        oc_outer, cm_outer, k_h, k_w, cm_inner, oc_inner = get_const_tuple(
            weight.shape)
