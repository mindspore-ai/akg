...
from akg.ops.nn.ascend.fused_batch_norm import FusedBatchNorm, batch_norm_tiling_strategy
...
@utils.check_input_type(akg.tvm.tensor.Tensor, akg.tvm.tensor.Tensor,
                          ...
                          (int, type(None)), (float, type(None)), (str, type(None)))
def BatchNormAd(head, data, mean, var, gamma, data_format="DefaultFormat", axis=1, eps=1e-3, target=utils.CCE):
    """
