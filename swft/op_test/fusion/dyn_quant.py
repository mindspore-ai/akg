...
def gen_golden_data():
    ...
    scaleOut.tofile(f"./temp/{OP_NAME}/output/gm_scale_golden.bin")
    yOut.tofile(f"./temp/{OP_NAME}/output/gm_y_golden.bin")
...
if __name__ == "__main__":
    ...
    exec_kernel(OP_NAME, locals(), prefix_path="temp", inputs=[
                'gm_x', 'token_len'], outputs=['gm_y', 'gm_scale'])
    script_dir = os.path.dirname(os.path.abspath(__file__))
    return_code_1 = os.system(
        f'python3 {script_dir}/../verify_result.py ./temp/{OP_NAME}/output/gm_scale_actual.bin ./temp/{OP_NAME}/output/gm_scale_golden.bin float32 1e-4 1e-4 4e-3')
    return_code_2 = os.system(
        f'python3 {script_dir}/../verify_result.py ./temp/{OP_NAME}/output/gm_y_actual.bin ./temp/{OP_NAME}/output/gm_y_golden.bin int8 1e-4 1e-4 4e-4')
