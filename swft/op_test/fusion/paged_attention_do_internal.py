...
def paged_attention_tp4(gm_q, k_cache, block_table, context_length, gm_pa, batch_size):
...
if __name__ == "__main__":
    ...
    paged_attention_tp4(gm_q, k_cache, block_table, context_length, gm_pa, batch_size)
