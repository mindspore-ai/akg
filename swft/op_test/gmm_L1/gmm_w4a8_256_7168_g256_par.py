...
OP_NAME = 'grouped_matmul_128_7168_transpose'
...
def grouped_matmul_128_7168_transpose(x, w, group_list, x_scale, y_scale, bias, out):
                ...
                for n in dynamic_loop(l1_tiling):
                    for k in dynamic_loop(l0b_tiling):
                        x_l0a_high = slice_to_l0A(
                            l1_high_x, [0,0],[16,K])
                        w_l0b = slice_to_l0B(
                            w_l1,[n * l1_tiling + k * l0b_tiling_size, 0],[l0b_tiling_size, K], transpose=True)
                        ...
                        ub_y_scale = slice_to_ub(y_scale, [
                                                i, 0, 0, block_idx * percore_size + n * l1_tiling_size + k * l0b_tiling_size],[1, 1, 1, l0b_tiling_size])
                        ...
                        ub_out_high = vmuls(ub_out_high_mul, 16)
                        ub_out_new = vadd(ub_out_high, ub_out_low_mul)
...
if __name__ == "__main__":
    ...
    compile_func(grouped_matmul_128_7168_transpose,globals())(gm_x,gm_weight,
