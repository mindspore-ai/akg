...
template <typename T> using ScalarPtr = std::shared_ptr<Scalar<T>>;
...
public:
    ...
    const std::vector<Scalar<int>> getShape() const;
...
template <typename T> class Scalar : public Value {
public:
    ...
    template <typename U> friend Scalar<U> operator+(U other, const Scalar<U> &scalar);
    Scalar<T> operator*(const Scalar<T> &other) const;
    Scalar<T> operator*(T other) const;
    template <typename U> friend Scalar<U> operator*(U other, const Scalar<U> &scalar);
    Scalar<T> operator-(const Scalar<T> &other) const;
    ...
    template <typename U> friend bool operator==(U other, const Scalar<U> &scalar);
    bool operator!=(const Scalar<T> &other) const;
    bool operator!=(T other) const;
    template <typename U> friend bool operator!=(U other, const Scalar<U> &scalar);
    bool operator<=(const Scalar<T> &other) const;
