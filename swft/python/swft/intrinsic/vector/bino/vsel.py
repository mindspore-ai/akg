...
class Vsel(Instruction):
    def __init__(self, x, y, conditions, out):
        self.inputs = (x, y, conditions)
        self.outputs = (out,)
        self.checker = Checker("VSEL", sel_memtype_infer, sel_dtype_infer, gather_format_infer, sel_shape_infer)
