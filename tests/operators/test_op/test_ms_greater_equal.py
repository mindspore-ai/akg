...
def test_ms_greater_equal(shape1, shape2, in_dtype, poly_sch=True, attrs=None):
    if not attrs:
        attrs = {"target": "cuda"}
    mod = utils.op_build_test(greater_equal, (shape1, shape2), (in_dtype, in_dtype),
                polyhedral=poly_sch, attrs=attrs, kernel_name="greater_equal")
