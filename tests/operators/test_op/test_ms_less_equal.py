...
def test_ms_less_equal(shape1, shape2, in_dtype, poly_sch=True, attrs=None):
    if not attrs:
        attrs = {"target": "cuda"}
    mod = utils.op_build_test(less_equal, (shape1, shape2), (in_dtype, in_dtype), kernel_name="less_equal",
