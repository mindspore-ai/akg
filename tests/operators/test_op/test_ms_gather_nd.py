...
def test_ms_gather_nd(shape1, dtype1, shape2, dtype2, poly_sch=True, attrs=None):
    if not attrs:
        attrs = {"target": "cuda"}
    mod = utils.op_build_test(gather_nd.gather_nd, [shape1, shape2], [dtype1, dtype2],
    ...
    if attrs["profiling"]:
        ...
        target_profiling(mod, params, indices, output, target=target_name, repeat_time=attrs["repeat_time"])
