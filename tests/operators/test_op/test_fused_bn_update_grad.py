...
from tests.operators.test_op.test_fused_pattern_grad import bn_beta_grad_np, bn_gamma_grad_np
...
def test_fused_bn_update_grad(shape, out_shape, dtype="float16", out_dtype="float32", layout="NHWC", poly_sch=True, attrs=None):
    if not attrs:
        attrs = {"target": "cuda"}
