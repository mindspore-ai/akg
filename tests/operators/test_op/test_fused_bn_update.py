...
def test_fused_bn_update(in_shape, dtype="float32", c1=(1 / (256 * 7 * 7)), c2=1.001e-05, c3=1.00007975, c4=0.100000024, poly_sch=False, attrs=None):
    if not attrs:
        attrs = {"target": "cuda"}
    ...
    if attrs["profiling"]:
        ...
        target_profiling(mod, *attrs_list, target=target_name, repeat_time=attrs["repeat_time"])
