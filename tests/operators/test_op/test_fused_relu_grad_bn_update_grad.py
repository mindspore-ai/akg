...
from tests.operators.test_op.test_fused_pattern_grad import relu_grad_np, bn_beta_grad_np, bn_gamma_grad_np
...
def test_fused_relu_grad_bn_update_grad(shape, out_shape, dtype="float16", layout="NHWC", out_dtype="float32", poly_sch=True, attrs=None):
    if not attrs:
        attrs = {"target": "cuda"}
