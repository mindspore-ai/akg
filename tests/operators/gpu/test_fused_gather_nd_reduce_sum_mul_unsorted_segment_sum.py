...
def test_fused_gather_nd_reduce_sum_mul_unsorted_segment_sum(
    input1_shape, input2_shape, input3_shape, input4_shape, data_dtype, indices_type, axis, keepdims, num, poly_sch=False, attrs=None):
    ...
    if poly_sch:
        mod = utils.op_build_test(fused_gather_nd_reduce_sum_mul_unsorted_segment_sum.fused_gather_nd_reduce_sum_mul_unsorted_segment_sum,
                                                               ...
                                                               attrs=default_attrs, kernel_name="fused_gather_nd_reduce_sum_mul_unsorted_segment_sum", )
    ...
    input1, input2, input3, input4, input5, output1, output2, expect1, expect2 = to_tvm_nd_array(
        [input1, input2, input3, input4, input5, output1, output2, expect1, expect2])
    gpu_profiling(mod, input1, input2, input3, input4, input5, output1, output2, expect1, expect2, repeat_time=400)
