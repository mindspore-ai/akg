...
class TestCase(TestBase):
    def setup(self):
        ...
        self.testarg = [
            ...
            ("transpose_run12", "transpose_run", ((4, 8, 16, 16), (0, 1, 3, 2), "float16"), ((32, 32), (32, 32), (32, 32), (32, 32))),
            ("transpose_run13", "transpose_run", ((4, 8, 128, 128), (0, 1, 3, 2), "float16"), ((1, 1), (1, 1), (128, 128), (128, 128))),
