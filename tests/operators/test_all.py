...
if __name__ == '__main__':
    ...
    def cpu_filter(item):
        op_filter = ["standard_normal", "conv",  "fused_gather_gather_add_mul_max_exp_scatter_add", "fused_gather_nd_reduce_sum_mul_unsorted_segment_sum",
                     "tensor_scatter_add", "unsorted_segment_sum", "csr_reduce_sum", "csr_mul", "csrmv"]
