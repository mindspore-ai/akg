...
from tests.common.test_op.dense import dense
from tests.common.test_op.concat import concat
from tests.common.test_op.split import split
from tests.common.test_op.sigmoid import sigmoid
...
def rnn_relu_cell_grad(input, hidden, w_ih, w_hh, b_ih, b_hh, grad):
    """
