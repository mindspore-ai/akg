...
from tests.common.test_op.ascend.apply_ftrl import apply_ftrl_impl

@utils.check_input_type(*([akg.tvm.tensor.Tensor]*9), (str, type(None)))
def apply_ftrl_v2(var, accum, linear, grad, lr, l1, l2, l2_shrinkage, lr_power, target=utils.CCE):
    """
