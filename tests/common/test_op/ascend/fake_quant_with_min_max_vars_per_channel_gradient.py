...
from tests.common.test_op.ascend.fake_quant_with_min_max_vars_per_channel import bool_both_zero_compute
from tests.common.test_op.ascend.fake_quant_with_min_max_vars_per_channel import nudged_min_max_compute
...
@utils.check_input_type(tvm.tensor.Tensor, tvm.tensor.Tensor,
