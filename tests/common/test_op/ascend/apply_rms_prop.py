...
@utils.check_input_type(*([akg.tvm.tensor.Tensor] * 7), float, (str, type(None)))
def apply_rms_prop(var, ms, mom, grad, lr, momentum, rho, epsilon, target=utils.CCE):
    """
...
@utils.check_input_type(*([akg.tvm.tensor.Tensor] * 7), float)
