...
@vc_util.check_input_type(*([akg.tvm.tensor.Tensor]*10 + [(bool, type(None))]))
def apply_adam(var, m, v, beta1_power, beta2_power, lr, beta1, beta2, epsilon, grad, use_nesterov=False):
    """
    ...
    # update by inplace
    (var_new, m_new, v_new), binds_info = utils.TensorUtils.inplace_set_tensors([var, m, v], [var_new, m_new, v_new])
