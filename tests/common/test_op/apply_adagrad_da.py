...
from tests.common.test_op.sqrt import sqrt
...
def _apply_adagrad_da_compute(var, gradient_accum, gradient_squared_accum,
    ...
    def select(l1, tmp_val, gradient_accum):
        ...
        return topi.cast(tmp_val, "float32") if utils.product_is_mini() else tmp_val
    ...
    if dtype == "float16":
        ...
        gradient_squared_accum = akg.lang.cce.cast_to(gradient_squared_accum, "float16")
...
def _check_inputs(var, grad_accum, grad_squared_accum, grad, lr, l1, l2, global_step):
    ...
    vc_util.ops_dtype_check(global_step.dtype, vc_util.DtypeForDavinci.INT32)
...
def apply_adagrad_da(var, grad_accum, grad_squared_accum, grad, lr, l1, l2, global_step):
    """
