...
"""operator dsl fuction: distr_normal_diag_KLdiv_ad"""
...
def dist_normal_diag_KLdiv_ad_set_dim_func(head, mean, scale):
    """
...
@ct_util.reg_set_dim_func(dist_normal_diag_KLdiv_ad_set_dim_func)
