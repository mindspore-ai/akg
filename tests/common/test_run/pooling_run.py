...
from tests.common.test_op.pooling import pooling
from tests.common.test_run.maxpool_run import gen_data as maxpool_gen_data
from tests.common.test_run.avgpool_run import gen_data as avgpool_gen_data
