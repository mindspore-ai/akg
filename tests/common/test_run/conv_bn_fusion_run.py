...
from akg.ops.nn import fused_batch_norm_split
from tests.common.gen_random import random_gaussian
from tests.common.tensorio import compare_tensor
from akg.utils import kernel_exec as utils
from tests.common.test_run.conv_utils import conv_param_prepare, conv_shape_4d, \
    conv_forward_naive, conv_tensor_4d_to_5d
from tests.common.test_run.bn_split_run import get_compile_param as get_bn_split_param
from tests.common.test_run.bn_split_run import bn_benchmark
...
def conv_bn_fusion_run(fm_shape, filter_shape, dtype, pad, stride, dilation,
    ...
    mod_bn3 = utils.op_build_test(fused_batch_norm_split.fused_bn3,
