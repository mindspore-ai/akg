...
from tests.common.test_op.gpu.fused_gather_gather_add_mul_max_exp_scatter_add import fused_gather_gather_add_mul_max_exp_scatter_add
...
def fused_gather_gather_add_mul_max_exp_scatter_add_run(input1_shape, input2_shape, input3_shape, input4_shape,
                                                         data_dtype, indices_type, axis, poly_sch=True, attrs=None):
    op_attrs = [axis]
    ...
    return (input1, input2, input3, input4), (output1, output2), (expect1, expect2), res