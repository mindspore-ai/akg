...
def mul_conv(data, fmap_shape, filter_shape, pad_, stride_, dilation_, bypass_l1=False, use_bias=False, block_size=16, attrs=None):
    a1 = data[0]
    a2 = data[1]
    b = data[2]
    ...
    if use_bias:
        ...
        conv_data = [a, b]
    res = conv.conv(conv_data, fmap_shape, filter_shape, pad_, stride_, dilation_, use_bias, block_size, attrs)
    return res
