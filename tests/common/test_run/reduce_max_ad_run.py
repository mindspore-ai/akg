...
from tests.common.test_op import reduce_max_ad
from tests.common.test_op.reduce_max_ad import reduce_max_ad
from tests.common.test_op.reduce_max_ad import reduce_max_ad_optimized
from tests.common.test_op.reduce_max_ad import reduce_max_ad_optimized_manual_schedule
from tests.common.tensorio import compare_tensor


def reduce_max_ad_run(shape, axis, keepdims, dtype, optimized, kernel_name="reduce_max", attrs=None, polyhedral=True):
    if attrs is None:
        attrs = {}
