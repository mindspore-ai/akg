...
import numpy as np
from tests.common.test_op.lstm_rnn_grad import lstmcell_grad_h
from tests.common.test_op.lstm_rnn_grad import lstmcell_grad_c, rnn_tanh_cell_grad, rnn_relu_cell_grad
from tests.common.test_op.lstm_rnn_ad import rnncell_tanh_ad, rnncell_relu_ad, lstmcell_h_ad, lstmcell_c_ad
