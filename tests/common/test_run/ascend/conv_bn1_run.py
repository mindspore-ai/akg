...
from akg.ops.nn.ascend import ConvBn1
from tests.common.gen_random import random_gaussian
from tests.common.test_run.ascend.conv_utils import conv_param_prepare, conv_shape_4d, conv_forward_naive, conv_tensor_4d_to_5d
...
def conv_bn1_run(fmap_shape, filter_shape, pad, stride, dilation,
    ...
    mod = utils.op_build_test(ConvBn1, [input_shape], [conv_dtype],
