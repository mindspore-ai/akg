...
import numpy as np
from tests.common.test_op.ascend.reduce_min_ad import reduce_min_ad
from tests.common.test_op.ascend.reduce_min_ad import reduce_min_ad_optimized
from tests.common.test_op.ascend.reduce_min_ad import reduce_min_ad_optimized_manual_schedule
from tests.common.tensorio import compare_tensor
from tests.common.gen_random import random_gaussian

def reduce_min_ad_run(shape, axis, keepdims, dtype, optimized, kernel_name="reduce_min", attrs_op={}, polyhedral=True, attrs={}):
