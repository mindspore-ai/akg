...
from tests.common.test_op.ascend.bitwise_or import bitwise_or
from tests.common.gen_random import random_gaussian


def bitwise_or_run(x_shape, x_dtype, y_shape, y_dtype, attrs):
    shapes = [x_shape, y_shape]
    dtypes = [x_dtype, y_dtype]
    mod = utils.op_build_test(bitwise_or, shapes, dtypes,
                              kernel_name="bitwise_or", attrs=attrs)
