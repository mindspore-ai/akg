...
from tests.common.test_op.ascend.avgpool_ad import avgpool_ad
from tests.common.test_op.ascend.avgpool_ad import avgpool_ad_no_custom_diff_manual_schedule
