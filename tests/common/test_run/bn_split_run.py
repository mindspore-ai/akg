...
def bn_1_run(shape, dtype, momentum, eps, kernel_name, attrs):
    ...
    if 'tuning' in attrs.keys():
        ...
        mod = utils.op_build_test(fused_batch_norm_split.fused_bn1,
                                  in_shapes, in_dtypes,
    ...
    mod_1 = utils.op_build_test(fused_batch_norm_split.fused_bn1,
                                in_shapes, in_dtypes,
...
def bn_2_run(shape, dtype, momentum, eps, kernel_name, attrs):
    ...
    if 'tuning' in attrs.keys():
        t = attrs.get("tuning", False)
        kernel_name = attrs.get("kernel_name", False)
        mod = utils.op_build_test(fused_batch_norm_split.fused_bn2,
                                  in_shapes, in_dtypes,
                                  op_attrs=[momentum],
                                  kernel_name=kernel_name,
                                  attrs=attrs, tuning=t)
    ...
    mod_2 = utils.op_build_test(fused_batch_norm_split.fused_bn2,
                                in_shapes, in_dtypes,
                                op_attrs=[momentum],
...
def bn_3_run(shape, dtype, momentum, eps, kernel_name, attrs):
    ...
    if 'tuning' in attrs.keys():
        t = attrs.get("tuning", False)
        kernel_name = attrs.get("kernel_name", False)
        mod = utils.op_build_test(fused_batch_norm_split.fused_bn3,
                                  in_shapes, in_dtypes,
                                  op_attrs=[eps],
                                  kernel_name=kernel_name,
                                  attrs=attrs, tuning=t)
    ...
    mod_3 = utils.op_build_test(fused_batch_norm_split.fused_bn3,
                                in_shapes, in_dtypes,
                                op_attrs=[eps],
