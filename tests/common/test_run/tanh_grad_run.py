...
from tests.common.test_op import tanh_grad
...
def tanh_grad_compile(shape, dtype, attrs, kernel_name='tanh_grad', tuning=False):
    return utils.op_build_test(tanh_grad.tanh_grad, [shape, shape], [dtype, dtype], kernel_name=kernel_name, attrs=attrs, tuning=tuning)
