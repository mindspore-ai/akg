...
from tests.common.test_op import gather


def gather_data(params_shape, indices_shape, params_dtype, indices_dtype):
    params_0, params_1 = params_shape
...
def gather_run(params_shape, indices_shape, params_dtype, indices_dtype, axis, attrs):
    if 'tuning' in attrs.keys():
        ...
        mod = utils.op_build_test(gather.gather, [params_shape, indices_shape], [params_dtype, indices_dtype], [axis],
        ...
        mod = gather.gather(params_shape, indices_shape, params_dtype, indices_dtype, axis, "gather_cce", "./")
