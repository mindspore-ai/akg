...
from tests.common.test_op import accumulate_nv2
...
def accumulate_nv2_compile(shape, dtype, n, attrs, kernel_name="accumulate_nv2", tuning=False):
    shapes = [shape] * n
    return utils.op_build_test(accumulate_nv2.accumulate_nv2, [shapes], [dtype],
                               kernel_name=kernel_name, attrs=attrs, tuning=tuning), shapes
