...
from tests.st.ops.gpu.test_fused_pattern_grad import relu_grad_np
...
def test_fused_relu_grad_bn_double_reduce_grad(shape, out_shape, dtype="float32", layout="NHWC", out_dtype="float16",
                                               poly_sch=False):
