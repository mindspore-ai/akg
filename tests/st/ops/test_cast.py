...
class TestCase(TestBase):
    ...
    def setup(self):
        ...
        self.args_default = [
            ...
            ("001_cast_test_case_16_dim_1", cast_run, ((16,), "float32", "float16"), ["level0"]),
            ("002_cast_test_case_1_23_dim_2", cast_run, ((1, 23), "float16", "float32"), ["level0"]),
            ("003_cast_test_case_15_400_dim_2", cast_run, ((15, 400), "float32", "float16"), ["level0"]),
            ("006_cast_test_case_16_16_123_dim_3", cast_run, ((16, 16, 123), "float32", "float16"), ["level0"]),
            ("007_cast_test_case_4_16_16_5_dim_4", cast_run, ((4, 16, 16, 5), "float32", "float16"), ["level0"]),
            ("008_cast_test_case_8_1_128_dim_2", cast_run, ((8, 1, 128), "float32", "float16"), ["level0"]),
            ("cast_test_case_263169_dim_1", cast_run, ((263169,), "bool", "float32"), ["level0"]),
            ("cast_test_case_21_dim_1", cast_run, ((21,), "bool", "float32"), ["level0"]),
            ("cast_test_case_1052676_dim_1", cast_run, ((1052676,), "bool", "int32"), ["level0"]),
            ("cast_test_case_328_500_3_dim_3", cast_run, ((328, 500, 3), "uint8", "float32"), ["level0"]),
            ("cast_test_case_330_500_1_dim_3", cast_run, ((330, 500, 1), "uint8", "int32"), ["level0"]),
        ]
        self.testarg_cloud = [
            # testflag,opfuncname,testRunArgs, dimArgs
