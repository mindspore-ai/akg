...
class TestCase(TestBase):
    def setup(self):
        ...
        self.args_default = [
            ("000_case", mul_run, (((512, 1), (512, 1)), 'float32'), ["level0"]),
            ("001_case", mul_run, (((1024, 2), (1024, 2)), 'float32'), ["level0"]),
            ("001_case", mul_run, (((2, 1024), (2, 1024)), 'float32'), ["level0"]),
            ("001_case", mul_run, (((1024, 1024), (1, 1024)), 'float32'), ["level0"]),
        ]
        return True
