...
from tests.common.test_run import tensor_scatter_add_run
...
class TestCase(TestBase):
    def setup(self):
        case_name = "tensor_scatter_add"
        case_path = os.getcwd()

        self.params_init(case_name, case_path)

        self.args_default = [
            ("000_case", tensor_scatter_add_run, ((19717, 8, 1), 'float32', (108365, 1), 'int32', 0), ["level0"]),
        ]
        return True
