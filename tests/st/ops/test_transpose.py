...
from tests.common.test_run import transpose_run

class TestCase(TestBase):
    def setup(self):
        case_name = "transpose_run"
        case_path = os.getcwd()
    ...
    def test_gpu_level0(self):
        return self.run_cases(self.args_outhers, utils.CUDA, "level0")
    
    @pytest.mark.level0
    @pytest.mark.platform_x86_cpu
    @pytest.mark.env_onecard
    def test_cpu_level0(self):
        return self.run_cases(self.args_outhers, utils.LLVM, "level0")