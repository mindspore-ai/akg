...
class TestCase(TestBase):
    ...
    def setup(self):
        ...
        self.testarg = [
            ...
            ("matmul_tanh_0", matmul_tanh_execute, ((4096, 12288), (4096, 768), 0,  "zN", "zN", "zN", True, False, "float16", None, "float32", "matmul_cce")),
            ("matmul_tanh_1", matmul_tanh_execute, ((4096, 12288), (12288, 768), 0,  "zN", "zN", "zN", False, False, "float16", None, "float16", "matmul_cce")),
            ("matmul_tanh_2", matmul_tanh_execute, ((4096, 192), (192, 12288), 0,  "zN", "zN", "zN", False, False, "float16", None, "float16", "matmul_cce")),
            ("matmul_tanh_3", matmul_tanh_execute, ((4096, 12288), (768, 12288), 0,  "zN", "zN", "zN", False, True, "float16", None, "float16", "matmul_cce")),
        ]
