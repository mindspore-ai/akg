...
int main(int argc, char **argv) {
  ...
  mlir::registerAKGAffinePasses();
  mlir::registerAKGMindSporePasses();
  mlir::registerAKGLinalgPasses();
  mlir::registerAKGTransformsPasses();
  mlir::registerAKGIRConversionPasses();
