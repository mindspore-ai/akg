          ...
          scf.for %arg6 = %c0 to %k step %c128 {                          // k o
            ...
            scf.for %arg7 = %c0 to %0 step %c8 {                          // m io
              ...
              scf.for %arg8 = %c0 to %1 step %c4 {                        // k io
                ...
                %44 = fusion.load %arg0[%c0, %c0, %100, %200], %cst {in_bounds = [true, true, false, false]} : memref<?x?x?x?xf16>, vector<1x1x8x4xf16>
                ...
                %666 = fusion.insert %arg0, %44 : memref<?x?x?x?xf16>, vector<1x1x8x4xf16> to vector<1x1x8x4xf16>
            ...
            scf.for %arg7 = %c0 to %n step %c32 {                        // n o
              ...
              scf.for %arg8 = %c0 to %2 step %c8 {                        // n io
                ...
                scf.for %arg9 = %c0 to %1 step %c4 {                      // k io
                  ...
                  %subview_7 = memref.subview %subview_5[0, 0, %arg8, %arg9] [1, 1, %4, %6] [1, 1, 1, 1] : memref<1x1x?x?xf16, strided<[?, ?, ?, 1], offset: ?>> to memref<1x1x?x?xf16, strided<[?, ?, ?, 1], offset: ?>>
                  %7 = vector.transfer_read %subview_7[%c0, %c0, %c0, %c0], %cst {in_bounds = [true, true, false, false]} : memref<1x1x?x?xf16, strided<[?, ?, ?, 1], offset: ?>>, vector<1x1x8x4xf16>
                  %8 = vector.transpose %7, [0, 1, 3, 2] : vector<1x1x8x4xf16> to vector<1x1x4x8xf16>
                  vector.transfer_write %8, %alloc_4[%3, %5, %c0, %c0, %c0, %c0] {in_bounds = [true, true, true, true]} : vector<1x1x4x8xf16>, memref<4x32x1x1x4x8xf16>
                }
              }
