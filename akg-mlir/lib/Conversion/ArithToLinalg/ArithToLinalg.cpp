...
void mlir::arith::populateArithToLinalgConversionPatterns(RewritePatternSet &patterns) {
  patterns.add<ElementwiseOpToLinalgBinary<arith::AddFOp, linalg::BinaryFn::add>,
               ...
               ElementwiseOpToLinalgBinary<arith::DivUIOp, linalg::BinaryFn::div_unsigned>,
               ElementwiseOpToLinalgBinary<arith::MaxSIOp, linalg::BinaryFn::max_signed>,
               ElementwiseOpToLinalgBinary<arith::MaxUIOp, linalg::BinaryFn::max_unsigned>,
               ElementwiseOpToLinalgBinary<arith::MinSIOp, linalg::BinaryFn::min_signed>,
               ElementwiseOpToLinalgBinary<arith::MinUIOp, linalg::BinaryFn::min_unsigned>,
               ...
               ElementwiseOpToLinalgUnary<math::FloorOp, linalg::UnaryFn::floor>>(patterns.getContext());
}

namespace {
struct ConvertArithToLinalgPass : public impl::ConvertArithToLinalgBase<ConvertArithToLinalgPass> {
...
std::unique_ptr<Pass> mlir::createArithToLinalgConversionPass() { return std::make_unique<ConvertArithToLinalgPass>(); }
