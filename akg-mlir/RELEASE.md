...
* Integrate Symbolic Tiling algorithm for AKG. [!764](https://gitee.com/mindspore/akg/pulls/764) (Ascend)
...
* Fix the bug when gcc version is less than 7.3. [!817](https://gitee.com/mindspore/akg/pulls/817) (All)
...
* fix multi output bug in emitter: when emit multi-output, should not convert real inputs.[!506](https://gitee.com/mindspore/akg/pulls/506) (ALL)
...
* [STABLE] The profiling suite for new runtime process.[!306](https://gitee.com/mindspore/akg/pulls/306)(ASCEND)

### Bug fixes

* Fixed memory promotion bug: sort the clusters before merging.[!338](https://gitee.com/mindspore/akg/pulls/338) (ASCEND)
* Fixed irregular-reduce bug: replace shfl.down with shared memory reduction.[!332](https://gitee.com/mindspore/akg/pulls/332) (GPU)
...
* [STABLE] Add Kahan algorithm for reduction operators. [!107](https://gitee.com/mindspore/akg/pulls/107) (GPU)
...
* Fixed local memory promotion for large thread
* Fixed reduce binding dimension issue on gpu platform
