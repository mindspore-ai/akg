...
namespace mlir {
#define GEN_PASS_DEF_AKGTOSAOPERATORIDENTIFY
#define GEN_PASS_DECL_AKGTOSAOPERATORIDENTIFY
...
namespace {
struct AKGOperatorIdentify : public impl::AKGTosaOperatorIdentifyBase<AKGOperatorIdentify> {
  AKGOperatorIdentify() {}
