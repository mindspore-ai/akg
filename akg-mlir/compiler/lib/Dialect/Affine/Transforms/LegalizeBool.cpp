...
template <> struct IntToFloatMap<arith::AddIOp> { using type = arith::AddFOp; };
template <> struct IntToFloatMap<arith::SubIOp> { using type = arith::SubFOp; };
template <> struct IntToFloatMap<arith::MulIOp> { using type = arith::MulFOp; };
template <> struct IntToFloatMap<arith::DivSIOp> { using type = arith::DivFOp; };
template <> struct IntToFloatMap<arith::DivUIOp> { using type = arith::DivFOp; };
template <> struct IntToFloatMap<arith::RemSIOp> { using type = arith::RemFOp; };
template <> struct IntToFloatMap<arith::RemUIOp> { using type = arith::RemFOp; };
template <> struct IntToFloatMap<arith::MaxSIOp> { using type = arith::MaximumFOp; };
template <> struct IntToFloatMap<arith::MaxUIOp> { using type = arith::MaximumFOp; };
template <> struct IntToFloatMap<arith::MinSIOp> { using type = arith::MinimumFOp; };
template <> struct IntToFloatMap<arith::MinUIOp> { using type = arith::MinimumFOp; };
