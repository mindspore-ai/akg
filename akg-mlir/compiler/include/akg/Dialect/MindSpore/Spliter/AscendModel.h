 ...
 */
#ifndef COMPILER_INCLUDE_AKG_DIALECT_MINDSPORE_SPLITER_ASCENDMODEL_H_
#define COMPILER_INCLUDE_AKG_DIALECT_MINDSPORE_SPLITER_ASCENDMODEL_H_
...
#endif  // COMPILER_INCLUDE_AKG_DIALECT_MINDSPORE_SPLITER_ASCENDMODEL_H_
