 ...
 */
#ifndef COMPILER_INCLUDE_AKG_DIALECT_MINDSPORE_SPLITER_CPUMODEL_H_
#define COMPILER_INCLUDE_AKG_DIALECT_MINDSPORE_SPLITER_CPUMODEL_H_
...
#endif  // COMPILER_INCLUDE_AKG_DIALECT_MINDSPORE_SPLITER_CPUMODEL_H_
