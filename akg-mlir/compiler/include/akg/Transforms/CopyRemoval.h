...
#ifndef COMPILER_INCLUDE_AKG_TRANSFORMS_COPYREMOVAL_H_
#define COMPILER_INCLUDE_AKG_TRANSFORMS_COPYREMOVAL_H_
...
#endif  // COMPILER_INCLUDE_AKG_TRANSFORMS_COPYREMOVAL_H_
