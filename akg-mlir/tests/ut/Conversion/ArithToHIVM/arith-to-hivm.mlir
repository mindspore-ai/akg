...
func.func @test_cmpf_oeq(%arg0 : memref<32x32xf32>, %arg1 : memref<32x32xf32>, %arg2 : memref<32x32xi1>) {
  // CHECK: %[[C0:.*]] = arith.constant 0 : index
  // CHECK: %{{.*}} = arith.constant 0.000000e+00 : f32
  // CHECK: %[[SV0:.*]] = memref.subview %arg0[0, 0] [32, 32] [1, 1] : memref<32x32xf32> to memref<32x32xf32, strided<[32, 1]>>
  // CHECK: %[[UB0:.*]] = memref.alloc() : memref<32x32xf32>
  ...
  // CHECK: hivm.hir.vcmp ins(%[[UB0]], %[[UB1]] : memref<32x32xf32>, memref<32x32xf32>) outs(%[[UB_OUT]] : memref<32x32xi8>)
  // CHECK: %[[SV_OUT:.*]] = memref.subview %arg2[0, 0] [32, 32] [1, 1] : memref<32x32xi1> to memref<32x32xi1, strided<[32, 1]>>
  // CHECK: %[[SV_OUT2:.*]] = hivm.hir.bitcast %[[SV_OUT]] : memref<32x32xi1, strided<[32, 1]>> -> memref<32x32xi8>
  // CHECK: hivm.hir.store ins(%[[UB_OUT]] : memref<32x32xi8>) outs(%[[SV_OUT2]] : memref<32x32xi8>)
  ...
  vector.transfer_write %res0, %arg2[%c0, %c0] : vector<32x32xi1>, memref<32x32xi1>
  return
}

// -----

func.func @test_cmpf_one(%arg0 : memref<32x32xf32>, %arg1 : memref<32x32xf32>, %arg2 : memref<32x32xi1>) {
  // CHECK: %[[C0:.*]] = arith.constant 0 : index
  // CHECK: %{{.*}} = arith.constant 0.000000e+00 : f32
  // CHECK: %[[SV0:.*]] = memref.subview %arg0[0, 0] [32, 32] [1, 1] : memref<32x32xf32> to memref<32x32xf32, strided<[32, 1]>>
  // CHECK: %[[UB0:.*]] = memref.alloc() : memref<32x32xf32>
  ...
  // CHECK: hivm.hir.load ins(%[[SV1]] : memref<32x32xf32, {{.*}}) outs(%[[UB1]] : memref<32x32xf32>)
  // CHECK: %[[UB_OUT:.*]] = memref.alloc() : memref<32x32xi8>
  // CHECK: hivm.hir.vcmp ins(%[[UB0]], %[[UB1]] : memref<32x32xf32>, memref<32x32xf32>) outs(%[[UB_OUT]] : memref<32x32xi8>) compare_mode = <ne>
  // CHECK: %[[SV_OUT:.*]] = memref.subview %arg2[0, 0] [32, 32] [1, 1] : memref<32x32xi1> to memref<32x32xi1, strided<[32, 1]>>
  // CHECK: %[[BITCAST_OUT:.*]] = hivm.hir.bitcast %[[SV_OUT:.*]] : memref<32x32xi1, strided<[32, 1]>> -> memref<32x32xi8>
  // CHECK: hivm.hir.store ins(%[[UB_OUT]] : memref<32x32xi8>) outs(%[[BITCAST_OUT]] : memref<32x32xi8>)
...
func.func @test_cmpf_ole(%arg0 : memref<32x32xf32>, %arg1 : memref<32x32xf32>, %arg2 : memref<32x32xi1>) {
  // CHECK: %[[C0:.*]] = arith.constant 0 : index
  // CHECK: %{{.*}} = arith.constant 0.000000e+00 : f32
  // CHECK: %[[SV0:.*]] = memref.subview %arg0[0, 0] [32, 32] [1, 1] : memref<32x32xf32> to memref<32x32xf32, strided<[32, 1]>>
  // CHECK: %[[UB0:.*]] = memref.alloc() : memref<32x32xf32>
  ...
  // CHECK: hivm.hir.load ins(%[[SV1]] : memref<32x32xf32, {{.*}}) outs(%[[UB1]] : memref<32x32xf32>)
  // CHECK: %[[UB_OUT:.*]] = memref.alloc() : memref<32x32xi8>
  // CHECK: hivm.hir.vcmp ins(%[[UB0]], %[[UB1]] : memref<32x32xf32>, memref<32x32xf32>) outs(%[[UB_OUT]] : memref<32x32xi8>) compare_mode = <le>
  // CHECK: %[[SV_OUT:.*]] = memref.subview %arg2[0, 0] [32, 32] [1, 1] : memref<32x32xi1> to memref<32x32xi1, strided<[32, 1]>>
  // CHECK: %[[BITCAST_OUT:.*]] = hivm.hir.bitcast %[[SV_OUT:.*]] : memref<32x32xi1, strided<[32, 1]>> -> memref<32x32xi8>
  // CHECK: hivm.hir.store ins(%[[UB_OUT]] : memref<32x32xi8>) outs(%[[BITCAST_OUT]] : memref<32x32xi8>)
...
func.func @test_cmpf_olt(%arg0 : memref<32x32xf32>, %arg1 : memref<32x32xf32>, %arg2 : memref<32x32xi1>) {
  // CHECK: %[[C0:.*]] = arith.constant 0 : index
  // CHECK: %{{.*}} = arith.constant 0.000000e+00 : f32
  // CHECK: %[[SV0:.*]] = memref.subview %arg0[0, 0] [32, 32] [1, 1] : memref<32x32xf32> to memref<32x32xf32, strided<[32, 1]>>
  // CHECK: %[[UB0:.*]] = memref.alloc() : memref<32x32xf32>
  ...
  // CHECK: hivm.hir.load ins(%[[SV1]] : memref<32x32xf32, {{.*}}) outs(%[[UB1]] : memref<32x32xf32>)
  // CHECK: %[[UB_OUT:.*]] = memref.alloc() : memref<32x32xi8>
  // CHECK: hivm.hir.vcmp ins(%[[UB0]], %[[UB1]] : memref<32x32xf32>, memref<32x32xf32>) outs(%[[UB_OUT]] : memref<32x32xi8>) compare_mode = <lt>
  // CHECK: %[[SV_OUT:.*]] = memref.subview %arg2[0, 0] [32, 32] [1, 1] : memref<32x32xi1> to memref<32x32xi1, strided<[32, 1]>>
  // CHECK: %[[BITCAST_OUT:.*]] = hivm.hir.bitcast %[[SV_OUT:.*]] : memref<32x32xi1, strided<[32, 1]>> -> memref<32x32xi8>
  // CHECK: hivm.hir.store ins(%[[UB_OUT]] : memref<32x32xi8>) outs(%[[BITCAST_OUT]] : memref<32x32xi8>)
...
func.func @test_cmpf_oge(%arg0 : memref<32x32xf32>, %arg1 : memref<32x32xf32>, %arg2 : memref<32x32xi1>) {
  // CHECK: %[[C0:.*]] = arith.constant 0 : index
  // CHECK: %{{.*}} = arith.constant 0.000000e+00 : f32
  // CHECK: %[[SV0:.*]] = memref.subview %arg0[0, 0] [32, 32] [1, 1] : memref<32x32xf32> to memref<32x32xf32, strided<[32, 1]>>
  // CHECK: %[[UB0:.*]] = memref.alloc() : memref<32x32xf32>
  ...
  // CHECK: hivm.hir.load ins(%[[SV1]] : memref<32x32xf32, {{.*}}) outs(%[[UB1]] : memref<32x32xf32>)
  // CHECK: %[[UB_OUT:.*]] = memref.alloc() : memref<32x32xi8>
  // CHECK: hivm.hir.vcmp ins(%[[UB0]], %[[UB1]] : memref<32x32xf32>, memref<32x32xf32>) outs(%[[UB_OUT]] : memref<32x32xi8>) compare_mode = <ge>
  // CHECK: %[[SV_OUT:.*]] = memref.subview %arg2[0, 0] [32, 32] [1, 1] : memref<32x32xi1> to memref<32x32xi1, strided<[32, 1]>>
  // CHECK: %[[BITCAST_OUT:.*]] = hivm.hir.bitcast %[[SV_OUT:.*]] : memref<32x32xi1, strided<[32, 1]>> -> memref<32x32xi8>
  // CHECK: hivm.hir.store ins(%[[UB_OUT]] : memref<32x32xi8>) outs(%[[BITCAST_OUT]] : memref<32x32xi8>)
...
func.func @test_cmpf_ogt(%arg0 : memref<32x32xf32>, %arg1 : memref<32x32xf32>, %arg2 : memref<32x32xi1>) {
  // CHECK: %[[C0:.*]] = arith.constant 0 : index
  // CHECK: %{{.*}} = arith.constant 0.000000e+00 : f32
  // CHECK: %[[SV0:.*]] = memref.subview %arg0[0, 0] [32, 32] [1, 1] : memref<32x32xf32> to memref<32x32xf32, strided<[32, 1]>>
  // CHECK: %[[UB0:.*]] = memref.alloc() : memref<32x32xf32>
  ...
  // CHECK: hivm.hir.load ins(%[[SV1]] : memref<32x32xf32, {{.*}}) outs(%[[UB1]] : memref<32x32xf32>)
  // CHECK: %[[UB_OUT:.*]] = memref.alloc() : memref<32x32xi8>
  // CHECK: hivm.hir.vcmp ins(%[[UB0]], %[[UB1]] : memref<32x32xf32>, memref<32x32xf32>) outs(%[[UB_OUT]] : memref<32x32xi8>) compare_mode = <gt>
  // CHECK: %[[SV_OUT:.*]] = memref.subview %arg2[0, 0] [32, 32] [1, 1] : memref<32x32xi1> to memref<32x32xi1, strided<[32, 1]>>
  // CHECK: %[[BITCAST_OUT:.*]] = hivm.hir.bitcast %[[SV_OUT:.*]] : memref<32x32xi1, strided<[32, 1]>> -> memref<32x32xi8>
  // CHECK: hivm.hir.store ins(%[[UB_OUT]] : memref<32x32xi8>) outs(%[[BITCAST_OUT]] : memref<32x32xi8>)
...
func.func @test_cmpf_ueq(%arg0 : memref<32x32xf32>, %arg1 : memref<32x32xf32>, %arg2 : memref<32x32xi1>) {
  // CHECK: %[[C0:.*]] = arith.constant 0 : index
  // CHECK: %{{.*}} = arith.constant 0.000000e+00 : f32
  // CHECK: %[[SV0:.*]] = memref.subview %arg0[0, 0] [32, 32] [1, 1] : memref<32x32xf32> to memref<32x32xf32, strided<[32, 1]>>
  // CHECK: %[[UB0:.*]] = memref.alloc() : memref<32x32xf32>
...
func.func @test_cmpf_une(%arg0 : memref<32x32xf32>, %arg1 : memref<32x32xf32>, %arg2 : memref<32x32xi1>) {
  // CHECK: %[[C0:.*]] = arith.constant 0 : index
  // CHECK: %{{.*}} = arith.constant 0.000000e+00 : f32
  // CHECK: %[[SV0:.*]] = memref.subview %arg0[0, 0] [32, 32] [1, 1] : memref<32x32xf32> to memref<32x32xf32, strided<[32, 1]>>
  // CHECK: %[[UB0:.*]] = memref.alloc() : memref<32x32xf32>
...
func.func @test_cmpf_ule(%arg0 : memref<32x32xf32>, %arg1 : memref<32x32xf32>, %arg2 : memref<32x32xi1>) {
  // CHECK: %[[C0:.*]] = arith.constant 0 : index
  // CHECK: %{{.*}} = arith.constant 0.000000e+00 : f32
  // CHECK: %[[SV0:.*]] = memref.subview %arg0[0, 0] [32, 32] [1, 1] : memref<32x32xf32> to memref<32x32xf32, strided<[32, 1]>>
  // CHECK: %[[UB0:.*]] = memref.alloc() : memref<32x32xf32>
...
func.func @test_cmpf_ult(%arg0 : memref<32x32xf32>, %arg1 : memref<32x32xf32>, %arg2 : memref<32x32xi1>) {
  // CHECK: %[[C0:.*]] = arith.constant 0 : index
  // CHECK: %{{.*}} = arith.constant 0.000000e+00 : f32
  // CHECK: %[[SV0:.*]] = memref.subview %arg0[0, 0] [32, 32] [1, 1] : memref<32x32xf32> to memref<32x32xf32, strided<[32, 1]>>
  // CHECK: %[[UB0:.*]] = memref.alloc() : memref<32x32xf32>
...
func.func @test_cmpf_uge(%arg0 : memref<32x32xf32>, %arg1 : memref<32x32xf32>, %arg2 : memref<32x32xi1>) {
  // CHECK: %[[C0:.*]] = arith.constant 0 : index
  // CHECK: %{{.*}} = arith.constant 0.000000e+00 : f32
  // CHECK: %[[SV0:.*]] = memref.subview %arg0[0, 0] [32, 32] [1, 1] : memref<32x32xf32> to memref<32x32xf32, strided<[32, 1]>>
  // CHECK: %[[UB0:.*]] = memref.alloc() : memref<32x32xf32>
...
func.func @test_cmpf_ugt(%arg0 : memref<32x32xf32>, %arg1 : memref<32x32xf32>, %arg2 : memref<32x32xi1>) {
  // CHECK: %[[C0:.*]] = arith.constant 0 : index
  // CHECK: %{{.*}} = arith.constant 0.000000e+00 : f32
  // CHECK: %[[SV0:.*]] = memref.subview %arg0[0, 0] [32, 32] [1, 1] : memref<32x32xf32> to memref<32x32xf32, strided<[32, 1]>>
  // CHECK: %[[UB0:.*]] = memref.alloc() : memref<32x32xf32>
...
func.func @test_cmpi_eq(%arg0 : memref<32x32xi32>, %arg1 : memref<32x32xi32>, %arg2 : memref<32x32xi1>) {
  // CHECK: %[[C0:.*]] = arith.constant 0 : index
  // CHECK: %{{.*}} = arith.constant 0 : i32
  // CHECK: %[[SV0:.*]] = memref.subview %arg0[0, 0] [32, 32] [1, 1] : memref<32x32xi32> to memref<32x32xi32, strided<[32, 1]>>
  // CHECK: %[[UB0:.*]] = memref.alloc() : memref<32x32xi32>
  ...
  // CHECK: hivm.hir.load ins(%[[SV1]] : memref<32x32xi32, {{.*}}) outs(%[[UB1]] : memref<32x32xi32>)
  // CHECK: %[[UB_OUT:.*]] = memref.alloc() : memref<32x32xi8>
  // CHECK: hivm.hir.vcmp ins(%[[UB0]], %[[UB1]] : memref<32x32xi32>, memref<32x32xi32>) outs(%[[UB_OUT]] : memref<32x32xi8>)
  // CHECK: %[[SV_OUT:.*]] = memref.subview %arg2[0, 0] [32, 32] [1, 1] : memref<32x32xi1> to memref<32x32xi1, strided<[32, 1]>>
  // CHECK: %[[SV_OUT2:.*]] = hivm.hir.bitcast %[[SV_OUT]] : memref<32x32xi1, strided<[32, 1]>> -> memref<32x32xi8>
  // CHECK: hivm.hir.store ins(%[[UB_OUT]] : memref<32x32xi8>) outs(%[[SV_OUT2]] : memref<32x32xi8>)
...
func.func @test_cmpi_ne(%arg0 : memref<32x32xi32>, %arg1 : memref<32x32xi32>, %arg2 : memref<32x32xi1>) {
  // CHECK: %[[C0:.*]] = arith.constant 0 : index
  // CHECK: %{{.*}} = arith.constant 0 : i32
  // CHECK: %[[SV0:.*]] = memref.subview %arg0[0, 0] [32, 32] [1, 1] : memref<32x32xi32> to memref<32x32xi32, strided<[32, 1]>>
  // CHECK: %[[UB0:.*]] = memref.alloc() : memref<32x32xi32>
  ...
  // CHECK: hivm.hir.load ins(%[[SV1]] : memref<32x32xi32, {{.*}}) outs(%[[UB1]] : memref<32x32xi32>)
  // CHECK: %[[UB_OUT:.*]] = memref.alloc() : memref<32x32xi8>
  // CHECK: hivm.hir.vcmp ins(%[[UB0]], %[[UB1]] : memref<32x32xi32>, memref<32x32xi32>) outs(%[[UB_OUT]] : memref<32x32xi8>) compare_mode = <ne>
  // CHECK: %[[SV_OUT:.*]] = memref.subview %arg2[0, 0] [32, 32] [1, 1] : memref<32x32xi1> to memref<32x32xi1, strided<[32, 1]>>
  // CHECK: %[[BITCAST_OUT:.*]] = hivm.hir.bitcast %[[SV_OUT:.*]] : memref<32x32xi1, strided<[32, 1]>> -> memref<32x32xi8>
  // CHECK: hivm.hir.store ins(%[[UB_OUT]] : memref<32x32xi8>) outs(%[[BITCAST_OUT]] : memref<32x32xi8>)
...
func.func @test_cmpi_slt(%arg0 : memref<32x32xi32>, %arg1 : memref<32x32xi32>, %arg2 : memref<32x32xi1>) {
  // CHECK: %[[C0:.*]] = arith.constant 0 : index
  // CHECK: %{{.*}} = arith.constant 0 : i32
  // CHECK: %[[SV0:.*]] = memref.subview %arg0[0, 0] [32, 32] [1, 1] : memref<32x32xi32> to memref<32x32xi32, strided<[32, 1]>>
  // CHECK: %[[UB0:.*]] = memref.alloc() : memref<32x32xi32>
  ...
  // CHECK: hivm.hir.load ins(%[[SV1]] : memref<32x32xi32, {{.*}}) outs(%[[UB1]] : memref<32x32xi32>)
  // CHECK: %[[UB_OUT:.*]] = memref.alloc() : memref<32x32xi8>
  // CHECK: hivm.hir.vcmp ins(%[[UB0]], %[[UB1]] : memref<32x32xi32>, memref<32x32xi32>) outs(%[[UB_OUT]] : memref<32x32xi8>) compare_mode = <lt>
  // CHECK: %[[SV_OUT:.*]] = memref.subview %arg2[0, 0] [32, 32] [1, 1] : memref<32x32xi1> to memref<32x32xi1, strided<[32, 1]>>
  // CHECK: %[[BITCAST_OUT:.*]] = hivm.hir.bitcast %[[SV_OUT:.*]] : memref<32x32xi1, strided<[32, 1]>> -> memref<32x32xi8>
  // CHECK: hivm.hir.store ins(%[[UB_OUT]] : memref<32x32xi8>) outs(%[[BITCAST_OUT]] : memref<32x32xi8>)
...
func.func @test_cmpi_sgt(%arg0 : memref<32x32xi32>, %arg1 : memref<32x32xi32>, %arg2 : memref<32x32xi1>) {
  // CHECK: %[[C0:.*]] = arith.constant 0 : index
  // CHECK: %{{.*}} = arith.constant 0 : i32
  // CHECK: %[[SV0:.*]] = memref.subview %arg0[0, 0] [32, 32] [1, 1] : memref<32x32xi32> to memref<32x32xi32, strided<[32, 1]>>
  // CHECK: %[[UB0:.*]] = memref.alloc() : memref<32x32xi32>
  ...
  // CHECK: hivm.hir.load ins(%[[SV1]] : memref<32x32xi32, {{.*}}) outs(%[[UB1]] : memref<32x32xi32>)
  // CHECK: %[[UB_OUT:.*]] = memref.alloc() : memref<32x32xi8>
  // CHECK: hivm.hir.vcmp ins(%[[UB0]], %[[UB1]] : memref<32x32xi32>, memref<32x32xi32>) outs(%[[UB_OUT]] : memref<32x32xi8>) compare_mode = <gt>
  // CHECK: %[[SV_OUT:.*]] = memref.subview %arg2[0, 0] [32, 32] [1, 1] : memref<32x32xi1> to memref<32x32xi1, strided<[32, 1]>>
  // CHECK: %[[BITCAST_OUT:.*]] = hivm.hir.bitcast %[[SV_OUT:.*]] : memref<32x32xi1, strided<[32, 1]>> -> memref<32x32xi8>
  // CHECK: hivm.hir.store ins(%[[UB_OUT]] : memref<32x32xi8>) outs(%[[BITCAST_OUT]] : memref<32x32xi8>)
...
func.func @test_cmpi_sle(%arg0 : memref<32x32xi32>, %arg1 : memref<32x32xi32>, %arg2 : memref<32x32xi1>) {
  // CHECK: %[[C0:.*]] = arith.constant 0 : index
  // CHECK: %{{.*}} = arith.constant 0 : i32
  // CHECK: %[[SV0:.*]] = memref.subview %arg0[0, 0] [32, 32] [1, 1] : memref<32x32xi32> to memref<32x32xi32, strided<[32, 1]>>
  // CHECK: %[[UB0:.*]] = memref.alloc() : memref<32x32xi32>
  ...
  // CHECK: hivm.hir.load ins(%[[SV1]] : memref<32x32xi32, {{.*}}) outs(%[[UB1]] : memref<32x32xi32>)
  // CHECK: %[[UB_OUT:.*]] = memref.alloc() : memref<32x32xi8>
  // CHECK: hivm.hir.vcmp ins(%[[UB0]], %[[UB1]] : memref<32x32xi32>, memref<32x32xi32>) outs(%[[UB_OUT]] : memref<32x32xi8>) compare_mode = <le>
  // CHECK: %[[SV_OUT:.*]] = memref.subview %arg2[0, 0] [32, 32] [1, 1] : memref<32x32xi1> to memref<32x32xi1, strided<[32, 1]>>
  // CHECK: %[[BITCAST_OUT:.*]] = hivm.hir.bitcast %[[SV_OUT:.*]] : memref<32x32xi1, strided<[32, 1]>> -> memref<32x32xi8>
  // CHECK: hivm.hir.store ins(%[[UB_OUT]] : memref<32x32xi8>) outs(%[[BITCAST_OUT]] : memref<32x32xi8>)
...
func.func @test_cmpi_sge(%arg0 : memref<32x32xi32>, %arg1 : memref<32x32xi32>, %arg2 : memref<32x32xi1>) {
  // CHECK: %[[C0:.*]] = arith.constant 0 : index
  // CHECK: %{{.*}} = arith.constant 0 : i32
  // CHECK: %[[SV0:.*]] = memref.subview %arg0[0, 0] [32, 32] [1, 1] : memref<32x32xi32> to memref<32x32xi32, strided<[32, 1]>>
  // CHECK: %[[UB0:.*]] = memref.alloc() : memref<32x32xi32>
  ...
  // CHECK: hivm.hir.load ins(%[[SV1]] : memref<32x32xi32, {{.*}}) outs(%[[UB1]] : memref<32x32xi32>)
  // CHECK: %[[UB_OUT:.*]] = memref.alloc() : memref<32x32xi8>
  // CHECK: hivm.hir.vcmp ins(%[[UB0]], %[[UB1]] : memref<32x32xi32>, memref<32x32xi32>) outs(%[[UB_OUT]] : memref<32x32xi8>) compare_mode = <ge>
  // CHECK: %[[SV_OUT:.*]] = memref.subview %arg2[0, 0] [32, 32] [1, 1] : memref<32x32xi1> to memref<32x32xi1, strided<[32, 1]>>
  // CHECK: %[[BITCAST_OUT:.*]] = hivm.hir.bitcast %[[SV_OUT:.*]] : memref<32x32xi1, strided<[32, 1]>> -> memref<32x32xi8>
  // CHECK: hivm.hir.store ins(%[[UB_OUT]] : memref<32x32xi8>) outs(%[[BITCAST_OUT]] : memref<32x32xi8>)
...
func.func @test_cmpi_ult(%arg0 : memref<32x32xi32>, %arg1 : memref<32x32xi32>, %arg2 : memref<32x32xi1>) {
  // CHECK: %[[C0:.*]] = arith.constant 0 : index
  // CHECK: %{{.*}} = arith.constant 0 : i32
  // CHECK: %[[SV0:.*]] = memref.subview %arg0[0, 0] [32, 32] [1, 1] : memref<32x32xi32> to memref<32x32xi32, strided<[32, 1]>>
  // CHECK: %[[UB0:.*]] = memref.alloc() : memref<32x32xi32>
...
func.func @test_cmpi_ugt(%arg0 : memref<32x32xi32>, %arg1 : memref<32x32xi32>, %arg2 : memref<32x32xi1>) {
  // CHECK: %[[C0:.*]] = arith.constant 0 : index
  // CHECK: %{{.*}} = arith.constant 0 : i32
  // CHECK: %[[SV0:.*]] = memref.subview %arg0[0, 0] [32, 32] [1, 1] : memref<32x32xi32> to memref<32x32xi32, strided<[32, 1]>>
  // CHECK: %[[UB0:.*]] = memref.alloc() : memref<32x32xi32>
...
func.func @test_cmpi_ule(%arg0 : memref<32x32xi32>, %arg1 : memref<32x32xi32>, %arg2 : memref<32x32xi1>) {
  // CHECK: %[[C0:.*]] = arith.constant 0 : index
  // CHECK: %{{.*}} = arith.constant 0 : i32
  // CHECK: %[[SV0:.*]] = memref.subview %arg0[0, 0] [32, 32] [1, 1] : memref<32x32xi32> to memref<32x32xi32, strided<[32, 1]>>
  // CHECK: %[[UB0:.*]] = memref.alloc() : memref<32x32xi32>
...
func.func @test_cmpi_uge(%arg0 : memref<32x32xi32>, %arg1 : memref<32x32xi32>, %arg2 : memref<32x32xi1>) {
  // CHECK: %[[C0:.*]] = arith.constant 0 : index
  // CHECK: %{{.*}} = arith.constant 0 : i32
  // CHECK: %[[SV0:.*]] = memref.subview %arg0[0, 0] [32, 32] [1, 1] : memref<32x32xi32> to memref<32x32xi32, strided<[32, 1]>>
  // CHECK: %[[UB0:.*]] = memref.alloc() : memref<32x32xi32>
...
func.func @test_select(%arg0 : memref<32x32xi1>, %arg1 : memref<32x32xf32>, %arg2 : memref<32x32xf32>, %arg3 : memref<32x32xf32>) {
  // CHECK: %[[C0:.*]] = arith.constant 0 : index
  // CHECK: %{{.*}} = arith.constant 0.000000e+00 : f32
  // CHECK: %{{.*}} = arith.constant false
  // CHECK: %[[SV0:.*]] = memref.subview %arg0[0, 0] [32, 32] [1, 1] : memref<32x32xi1> to memref<32x32xi1, strided<[32, 1]>>
  // CHECK: %[[BITCAST_IN:.*]] = hivm.hir.bitcast %[[SV0:.*]] : memref<32x32xi1, strided<[32, 1]>> -> memref<32x32xi8>
  // CHECK: %[[UB0:.*]] = memref.alloc() : memref<32x32xi8>
  // CHECK: hivm.hir.load ins(%[[BITCAST_IN]] : memref<32x32xi8>) outs(%[[UB0]] : memref<32x32xi8>)
  // CHECK: %[[SV1:.*]] = memref.subview %arg1[0, 0] [32, 32] [1, 1] : memref<32x32xf32> to memref<32x32xf32, strided<[32, 1]>>
  // CHECK: %[[UB1:.*]] = memref.alloc() : memref<32x32xf32>
  // CHECK: hivm.hir.load ins(%[[SV1]] : memref<32x32xf32, {{.*}}>) outs(%[[UB1]] : memref<32x32xf32>)
  // CHECK: %[[SV2:.*]] = memref.subview %arg2[0, 0] [32, 32] [1, 1] : memref<32x32xf32> to memref<32x32xf32, strided<[32, 1]>>
  // CHECK: %[[UB2:.*]] = memref.alloc() : memref<32x32xf32>
  // CHECK: hivm.hir.load ins(%[[SV2]] : memref<32x32xf32, {{.*}}>) outs(%[[UB2]] : memref<32x32xf32>)
  // CHECK: %[[UB_OUT:.*]] = memref.alloc() : memref<32x32xf32>
  // CHECK: hivm.hir.vsel ins(%[[UB0]], %[[UB1]], %[[UB2]] : memref<32x32xi8>, memref<32x32xf32>, memref<32x32xf32>) outs(%[[UB_OUT]] : memref<32x32xf32>)
  // CHECK: %[[SV_OUT:.*]] = memref.subview %arg3[0, 0] [32, 32] [1, 1] : memref<32x32xf32> to memref<32x32xf32, strided<[32, 1]>>
  // CHECK: hivm.hir.store ins(%[[UB_OUT]] : memref<32x32xf32>) outs(%[[SV_OUT]] : memref<32x32xf32, {{.*}}>)

  %c0 = arith.constant 0 : index
  %cst = arith.constant 0.0 : f32
  %cst_i1 = arith.constant false
  %v0 = vector.transfer_read %arg0[%c0, %c0], %cst_i1 : memref<32x32xi1>, vector<32x32xi1>
  %v1 = vector.transfer_read %arg1[%c0, %c0], %cst : memref<32x32xf32>, vector<32x32xf32>
  %v2 = vector.transfer_read %arg2[%c0, %c0], %cst : memref<32x32xf32>, vector<32x32xf32>
  %0 = arith.select %v0, %v1, %v2 : vector<32x32xi1>, vector<32x32xf32>
  vector.transfer_write %0, %arg3[%c0, %c0] : vector<32x32xf32>, memref<32x32xf32>
  return
}
...
func.func @test_vector_reduction_xor_standard(%arg0: memref<16xi32>, %arg1: memref<1xi32>) {
  ...
  // CHECK: %[[INIT_VAL:.*]] = arith.constant 0 : i32
  // CHECK: %[[ZERO_IDX:.*]] = arith.constant 0 : index
  // CHECK: memref.store %[[INIT_VAL]], %[[ALLOC_RED]][%[[ZERO_IDX]]] : memref<1xi32>
  // CHECK: hivm.hir.vreduce <xori> ins(%[[ALLOC_READ]] : memref<16xi32>) outs(%[[ALLOC_RED]] : memref<1xi32>) reduce_dims = [0]
  // CHECK: %[[SCALAR_RES:.*]] = memref.load %[[ALLOC_RED]][%[[ZERO_IDX]]] : memref<1xi32>
  // CHECK: %[[ALLOC_BRC:.*]] = memref.alloc() : memref<1xi32>
  // CHECK: hivm.hir.vbrc ins(%[[SCALAR_RES]] : i32) outs(%[[ALLOC_BRC]] : memref<1xi32>)
  // CHECK: %[[SUBVIEW_WRITE:.*]] = memref.subview %[[ARG1]][0] [1] [1] : memref<1xi32> to memref<1xi32, strided<[1]>>
  // CHECK: hivm.hir.store ins(%[[ALLOC_BRC]] : memref<1xi32>) outs(%[[SUBVIEW_WRITE]] : memref<1xi32, strided<[1]>>)
...
func.func @test_vector_reduction_mul_i32(%arg0: memref<16xi32>, %arg1: memref<1xi32>) {
  ...
  // CHECK: hivm.hir.load ins(%[[SUBVIEW_READ]] : memref<16xi32, strided<[1]>>) outs(%[[ALLOC_READ]] : memref<16xi32>)
  // CHECK: %[[ALLOC_RED:.*]] = memref.alloc() : memref<1xi32>
  // CHECK: %[[INIT_VAL:.*]] = arith.constant 1 : i32
  // CHECK: %[[ZERO_IDX:.*]] = arith.constant 0 : index
  // CHECK: memref.store %[[INIT_VAL]], %[[ALLOC_RED]][%[[ZERO_IDX]]] : memref<1xi32>
...
func.func @test_vector_reduction_add_f32(%arg0: memref<16xf32>, %arg1: memref<1xf32>) {
  ...
  // CHECK: %[[INIT_VAL:.*]] = arith.constant 0.000000e+00 : f32
  // CHECK: %[[ZERO_IDX:.*]] = arith.constant 0 : index
  // CHECK: memref.store %[[INIT_VAL]], %[[ALLOC_RED]][%[[ZERO_IDX]]] : memref<1xf32>
  // CHECK: hivm.hir.vreduce <sum> ins(%[[ALLOC_READ]] : memref<16xf32>) outs(%[[ALLOC_RED]] : memref<1xf32>) reduce_dims = [0]
  // CHECK: %[[SCALAR_RES:.*]] = memref.load %[[ALLOC_RED]][%[[ZERO_IDX]]] : memref<1xf32>
  // CHECK: %[[ALLOC_BRC:.*]] = memref.alloc() : memref<1xf32>
  // CHECK: hivm.hir.vbrc ins(%[[SCALAR_RES]] : f32) outs(%[[ALLOC_BRC]] : memref<1xf32>)
  // CHECK: %[[SUBVIEW_WRITE:.*]] = memref.subview %[[ARG1]][0] [1] [1] : memref<1xf32> to memref<1xf32, strided<[1]>>
  // CHECK: hivm.hir.store ins(%[[ALLOC_BRC]] : memref<1xf32>) outs(%[[SUBVIEW_WRITE]] : memref<1xf32, strided<[1]>>)
...
func.func @test_vector_reduction_mul_f32(%arg0: memref<16xf32>, %arg1: memref<1xf32>) {
  ...
  // CHECK: hivm.hir.load ins(%[[SUBVIEW_READ]] : memref<16xf32, strided<[1]>>) outs(%[[ALLOC_READ]] : memref<16xf32>)
  // CHECK: %[[ALLOC_RED:.*]] = memref.alloc() : memref<1xf32>
  // CHECK: %[[INIT_VAL:.*]] = arith.constant 1.000000e+00 : f32
  // CHECK: %[[ZERO_IDX:.*]] = arith.constant 0 : index
  // CHECK: memref.store %[[INIT_VAL]], %[[ALLOC_RED]][%[[ZERO_IDX]]] : memref<1xf32>
