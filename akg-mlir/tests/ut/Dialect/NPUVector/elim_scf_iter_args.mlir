...
// CHECK-NEXT:    %cst_1 = arith.constant dense<0.000000e+00> : !npuvector<128xf32>
// CHECK-NEXT:    %cst_2 = arith.constant dense<0.000000e+00> : !npuvector<128xf32>
// CHECK-NEXT:    %c0_3 = arith.constant 0 : index
// CHECK-NEXT:    %alloc = memref.alloc() : memref<128xf32>
// CHECK-NEXT:    %alloc_4 = memref.alloc() : memref<128xf32>
// CHECK-NEXT:    npuvector.transfer_write %cst_1, %alloc[%c0_3] : !npuvector<128xf32>, memref<128xf32>
// CHECK-NEXT:    npuvector.transfer_write %cst_2, %alloc_4[%c0_3] : !npuvector<128xf32>, memref<128xf32>
...
// CHECK-NEXT:      %5 = npuvector.transfer_read %alloc_4[%c0_11] [%c128_15] [%c128_16], %cst_17 : memref<128xf32>, !npuvector<128xf32>
...
// CHECK-NEXT:      npuvector.transfer_write %11, %alloc_4[%c0_11] : !npuvector<128xf32>, memref<128xf32>
// CHECK-NEXT:    }
...
// CHECK-NEXT:    %0 = npuvector.transfer_read %alloc[%c0_3] [%c128_5] [%c128_6], %cst_7 : memref<128xf32>, !npuvector<128xf32>
...
// CHECK-NEXT:    %1 = npuvector.transfer_read %alloc_4[%c0_3] [%c128_8] [%c128_9], %cst_10 : memref<128xf32>, !npuvector<128xf32>
