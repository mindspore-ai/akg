...
// CHECK:    %alloc_5 = memref.alloc() {alignment = 64 : i64} : memref<256x10x10xf32, {SymShapeAttr = ["s0", "s2", "s1"]}>
// CHECK:    %alloc_6 = memref.alloc() {alignment = 64 : i64} : memref<256x10x10xf32, {SymShapeAttr = ["s0", "s2", "s1"]}>
// CHECK:    %alloc_7 = memref.alloc() {alignment = 64 : i64} : memref<10x10xf32, {SymShapeAttr = ["s2", "s1"]}>
// CHECK:    %alloc_8 = memref.alloc() {alignment = 64 : i64} : memref<10x10xf32, {SymShapeAttr = ["s2", "s1"]}>
// CHECK:    %alloc_9 = memref.alloc() {alignment = 64 : i64} : memref<10x10xf32, {SymShapeAttr = ["s2", "s1"]}>
// CHECK:    %alloc_10 = memref.alloc() {alignment = 64 : i64} : memref<256x10x10xf32, {SymShapeAttr = ["s0", "s2", "s1"]}>
// CHECK:    %alloc_11 = memref.alloc() {alignment = 64 : i64} : memref<256x10x10xf32, {SymShapeAttr = ["s0", "s2", "s1"]}>
// CHECK:    %expand_shape = memref.expand_shape %alloc_11 {{.*}} output_shape [256, 1, 10, 10] : memref<256x10x10xf32, {SymShapeAttr = ["s0", "s2", "s1"]}> into memref<256x1x10x10xf32, {SymShapeAttr = ["s0", "s2", "s1"]}>
...
// CHECK:          %0 = affine.load %arg0[%arg2, %arg4] : memref<256x10xi32, {SymShapeAttr = ["s0", "s1"]}>
// CHECK:          affine.store %0, %alloc[%arg2, %arg3, %arg4] : memref<256x10x10xi32, {SymShapeAttr = ["s0", "s2", "s1"]}>
// CHECK:        }
// CHECK:      }
// CHECK:    }
// CHECK:    affine.for %arg2 = 0 to 256 {
// CHECK:      affine.for %arg3 = 0 to 10 {
// CHECK:        affine.for %arg4 = 0 to 10 {
// CHECK:          %0 = affine.load %alloc[%arg2, %arg3, %arg4] : memref<256x10x10xi32, {SymShapeAttr = ["s0", "s2", "s1"]}>
// CHECK:          %1 = arith.sitofp %0 : i32 to f32
// CHECK:          affine.store %1, %alloc_2[%arg2, %arg3, %arg4] : memref<256x10x10xf32, {SymShapeAttr = ["s0", "s2", "s1"]}>
// CHECK:        }
// CHECK:      }
// CHECK:    }
// CHECK:    affine.for %arg2 = 0 to 256 {
// CHECK:      affine.for %arg3 = 0 to 10 {
// CHECK:        affine.for %arg4 = 0 to 10 {
// CHECK:          %0 = affine.load %alloc_2[%arg2, %arg3, %arg4] : memref<256x10x10xf32, {SymShapeAttr = ["s0", "s2", "s1"]}>
// CHECK:          %1 = arith.subf %cst, %0 : f32
// CHECK:          affine.store %1, %alloc_3[%arg2, %arg3, %arg4] : memref<256x10x10xf32, {SymShapeAttr = ["s0", "s2", "s1"]}>
// CHECK:        }
// CHECK:      }
// CHECK:    }
// CHECK:    affine.for %arg2 = 0 to 256 {
// CHECK:      affine.for %arg3 = 0 to 10 {
// CHECK:        affine.for %arg4 = 0 to 10 {
// CHECK:          %0 = affine.load %alloc_3[%arg2, %arg3, %arg4] : memref<256x10x10xf32, {SymShapeAttr = ["s0", "s2", "s1"]}>
// CHECK:          %1 = arith.cmpf une, %0, %cst_1 : f32
// CHECK:          affine.store %1, %alloc_4[%arg2, %arg3, %arg4] : memref<256x10x10xi1, {SymShapeAttr = ["s0", "s2", "s1"]}>
// CHECK:        }
// CHECK:      }
// CHECK:    }
// CHECK:    affine.for %arg2 = 0 to 256 {
// CHECK:      affine.for %arg3 = 0 to 10 {
// CHECK:        affine.for %arg4 = 0 to 10 {
// CHECK:          affine.store %cst_0, %alloc_5[%arg2, %arg3, %arg4] : memref<256x10x10xf32, {SymShapeAttr = ["s0", "s2", "s1"]}>
// CHECK:        }
// CHECK:      }
// CHECK:    }
// CHECK:    affine.for %arg2 = 0 to 256 {
// CHECK:      affine.for %arg3 = 0 to 10 {
// CHECK:        affine.for %arg4 = 0 to 10 {
// CHECK:          %0 = affine.load %alloc_4[%arg2, %arg3, %arg4] : memref<256x10x10xi1, {SymShapeAttr = ["s0", "s2", "s1"]}>
// CHECK:          %1 = affine.load %alloc_5[%arg2, %arg3, %arg4] : memref<256x10x10xf32, {SymShapeAttr = ["s0", "s2", "s1"]}>
// CHECK:          %2 = affine.load %alloc_3[%arg2, %arg3, %arg4] : memref<256x10x10xf32, {SymShapeAttr = ["s0", "s2", "s1"]}>
// CHECK:          %3 = arith.select %0, %1, %2 : f32
// CHECK:          affine.store %3, %alloc_6[%arg2, %arg3, %arg4] : memref<256x10x10xf32, {SymShapeAttr = ["s0", "s2", "s1"]}>
// CHECK:        }
// CHECK:      }
// CHECK:    }
// CHECK:    affine.for %arg2 = 0 to 10 {
// CHECK:      affine.for %arg3 = 0 to 10 {
// CHECK:        affine.store %cst_1, %alloc_7[%arg2, %arg3] : memref<10x10xf32, {SymShapeAttr = ["s2", "s1"]}>
// CHECK:      }
// CHECK:    }
// CHECK:    affine.for %arg2 = 0 to 10 {
// CHECK:      affine.for %arg3 = 0 to 10 {
// CHECK:        affine.store %cst_0, %alloc_8[%arg2, %arg3] : memref<10x10xf32, {SymShapeAttr = ["s2", "s1"]}>
// CHECK:      }
// CHECK:    }
// CHECK:    affine.for %arg2 = 0 to 10 {
// CHECK:      affine.for %arg3 = 0 to 10 {
// CHECK:        %0 = affine.load %arg1[%arg2, %arg3] : memref<10x10xi1, {SymShapeAttr = ["s2", "s1"]}>
// CHECK:        %1 = affine.load %alloc_7[%arg2, %arg3] : memref<10x10xf32, {SymShapeAttr = ["s2", "s1"]}>
// CHECK:        %2 = affine.load %alloc_8[%arg2, %arg3] : memref<10x10xf32, {SymShapeAttr = ["s2", "s1"]}>
// CHECK:        %3 = arith.select %0, %1, %2 : f32
// CHECK:        affine.store %3, %alloc_9[%arg2, %arg3] : memref<10x10xf32, {SymShapeAttr = ["s2", "s1"]}>
// CHECK:      }
// CHECK:    }
// CHECK:    affine.for %arg2 = 0 to 256 {
// CHECK:      affine.for %arg3 = 0 to 10 {
// CHECK:        affine.for %arg4 = 0 to 10 {
// CHECK:          %0 = affine.load %alloc_9[%arg3, %arg4] : memref<10x10xf32, {SymShapeAttr = ["s2", "s1"]}>
// CHECK:          affine.store %0, %alloc_10[%arg2, %arg3, %arg4] : memref<256x10x10xf32, {SymShapeAttr = ["s0", "s2", "s1"]}>
// CHECK:        }
// CHECK:      }
// CHECK:    }
// CHECK:    affine.for %arg2 = 0 to 256 {
// CHECK:      affine.for %arg3 = 0 to 10 {
// CHECK:        affine.for %arg4 = 0 to 10 {
// CHECK:          %0 = affine.load %alloc_6[%arg2, %arg3, %arg4] : memref<256x10x10xf32, {SymShapeAttr = ["s0", "s2", "s1"]}>
// CHECK:          %1 = affine.load %alloc_10[%arg2, %arg3, %arg4] : memref<256x10x10xf32, {SymShapeAttr = ["s0", "s2", "s1"]}>
// CHECK:          %2 = arith.addf %0, %1 : f32
// CHECK:          affine.store %2, %alloc_11[%arg2, %arg3, %arg4] : memref<256x10x10xf32, {SymShapeAttr = ["s0", "s2", "s1"]}>
// CHECK:        }
// CHECK:      }
// CHECK:    }
