...
#define AKG_DIALECT_AFFINE_TRANSFORMS_SUPERVECTORIZE_H_
...
struct VectorizationState {
  explicit VectorizationState(MLIRContext *context) : builder(context) {}
...
#endif  // AKG_DIALECT_AFFINE_TRANSFORMS_SUPERVECTORIZE_H_
