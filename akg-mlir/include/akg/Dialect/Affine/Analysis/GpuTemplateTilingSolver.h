...
#ifndef AKG_DIALECT_AFFINE_ANALYSIS_GPUTEMPLATETILINGSOLVER_H_
#define AKG_DIALECT_AFFINE_ANALYSIS_GPUTEMPLATETILINGSOLVER_H_
#include <deque>
#include <tuple>
#include <vector>
...
#endif  // AKG_DIALECT_AFFINE_ANALYSIS_GPUTEMPLATETILINGSOLVER_H_
