...
#ifndef AKG_DIALECT_AFFINE_ANALYSIS_LOOPFUSIONANALYZER_H_
#define AKG_DIALECT_AFFINE_ANALYSIS_LOOPFUSIONANALYZER_H_
...
#endif  // AKG_DIALECT_AFFINE_ANALYSIS_LOOPFUSIONANALYZER_H_
