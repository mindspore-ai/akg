...
#define AKG_DIALECT_AFFINE_ANALYSIS_AFFINEANALYSIS_H
...
Value getSourceMemRef(Value memrefVal, bool *hasSubView = nullptr, memref::SubViewOp *firstSubView = nullptr);
...
#endif  // AKG_DIALECT_AFFINE_ANALYSIS_AFFINEANALYSIS_H
