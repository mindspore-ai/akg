...
//===----------------------------------------------------------------------===//
#ifndef AKG_CONVERSION_SCFTOGPUEXT_SCFTOGPUPASSEXT_H_
#define AKG_CONVERSION_SCFTOGPUEXT_SCFTOGPUPASSEXT_H_
#include <memory>
...
#endif  // AKG_CONVERSION_SCFTOGPUEXT_SCFTOGPUPASSEXT_H_
