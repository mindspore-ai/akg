...
#ifndef AKG_TRANSFORMS_PASSES_H_
#define AKG_TRANSFORMS_PASSES_H_

#include <memory>
#include <string>
#include "akg/Transforms/FuncOutlining.h"
#include "akg/Transforms/ParallelLaunch.h"
#include "akg/Transforms/OperatorIdentify.h"
...
std::unique_ptr<Pass> createSubviewAllocElimPass();
std::unique_ptr<Pass> createFoldMemRefSubViewOnlyPass();
...
#endif  // AKG_TRANSFORMS_PASSES_H_
