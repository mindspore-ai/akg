...
#ifndef AKG_DIALECT_TOSA_TRANSFORMS_FOLDDIMENSION_H_
#define AKG_DIALECT_TOSA_TRANSFORMS_FOLDDIMENSION_H_
...
using TensorInfoMap = llvm::DenseMap<Value, std::pair<std::pair<llvm::SmallDenseSet<Value>, llvm::SmallDenseSet<Value>>,
                                                      std::pair<llvm::SmallVector<int64_t>, std::string>>>;
...
#endif  // AKG_DIALECT_TOSA_TRANSFORMS_FOLDDIMENSION_H_
