...
#ifndef AKG_ANALYSIS_SYMBOLICSHAPEANALYSIS_H_
#define AKG_ANALYSIS_SYMBOLICSHAPEANALYSIS_H_
...
class SymbolicShapeAnalysis {
 public:
  ...
  Type removeSymbolicShape(Type type) const;
...
#endif  // AKG_ANALYSIS_SYMBOLICSHAPEANALYSIS_H_
