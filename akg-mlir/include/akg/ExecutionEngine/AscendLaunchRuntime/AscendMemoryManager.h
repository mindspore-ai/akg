...
#ifndef AKG_EXECUTIONENGINE_ASCENDLAUNCHRUNTIME_ASCENDMEMORYMANAGER_H_
#define AKG_EXECUTIONENGINE_ASCENDLAUNCHRUNTIME_ASCENDMEMORYMANAGER_H_
#include <memory>
#include <utility>
#include <vector>
...
#endif  // AKG_EXECUTIONENGINE_ASCENDLAUNCHRUNTIME_ASCENDMEMORYMANAGER_H_
