 ...
 */
#ifndef AKG_EXECUTIONENGINE_ASCENDLAUNCHRUNTIME_TENSORDEVICE_H_
#define AKG_EXECUTIONENGINE_ASCENDLAUNCHRUNTIME_TENSORDEVICE_H_
#include <cstddef>
#include <memory>
#include <type_traits>
#include <cstring>
...
class ScalarDevice : public BaseDevice {
 public:
  ...
  void *GetScalarValuePtr() const { return data_ptr_; }
...
class TensorDevice : public BaseDevice {
 public:
  TensorDevice(void *host_address, size_t nbytes, bool is_output)
      : host_address_(host_address), device_address_(nullptr), nbytes_(nbytes), is_output_(is_output) {}
...
#endif  // AKG_EXECUTIONENGINE_ASCENDLAUNCHRUNTIME_TENSORDEVICE_H_
