...
从 2.4 版本之后，我们对 AKG 进行了全新升级，当前的 AKG 项目中，包含了 AKG-AGENT、AKG-MLIR 2个子项目，支持 CPU、NVIDIA、V100/A100、Atlas 800T A2/A3、300I DUO 等多硬件后端的算子自动生成。
...
- **AKG-AGENT：** 请参考 [AKG-AGENT](./akg_agents/README_CN.md) 文档
