...
from ai_kernel_generator.cli.constants import Defaults, SyntaxLanguage
from ai_kernel_generator.cli.utils.paths import get_stream_save_dir
...
class StreamRenderer:
    ...
    def __init__(
        ...
        self.painter = ConsolePainter(console)
        ...
        for i, line in enumerate(lines):
            ...
            if self.state.in_json_block:
                ...
                self.json_processor.process_line(
                    line, self.state, dim=self.state.json_dim
                )
                continue
    ...
    def _handle_fence(
        self, stripped_line: str, original_line: str, *, dim: bool = False
    ):
        """处理 ``` 标记"""
        ...
        if self.state.in_code_block or self.state.in_json_block:
            ...
            if self.state.in_json_block:
                ...
                consumed = self.painter.print_syntax_block(
                    ...
                    line_number_start=self.state.get_line_number(
