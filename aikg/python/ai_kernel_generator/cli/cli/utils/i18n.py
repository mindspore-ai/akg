...
_STRINGS: Mapping[str, Mapping[str, str]] = {
    "zh": {
        ...
        "theme.light": "浅色",
        # ===== TUI: bindings =====
        "tui.binding.cancel_or_quit": "取消/退出",
        ...
        "tui.binding.copy_job_id": "复制任务ID",
        ...
        "tui.binding.toggle_mouse": "切换鼠标模式",
        "tui.binding.mouse_on": "开启鼠标模式",
        "tui.binding.mouse_off": "关闭鼠标模式",
        "tui.msg.mouse_enabled": "鼠标交互：已开启",
        "tui.msg.mouse_disabled": "原生选区：已开启（鼠标交互已关闭）",
        "tui.msg.mouse_toggle_failed": "切换鼠标模式失败",
        # ===== TUI: titles / placeholders =====
        "tui.title.tasks_bar": "任务",
        "tui.title.tasks_bar_mouse": "任务（点击/左右键切换）",
        "tui.title.tasks_bar_nomouse": "任务（左右键切换）",
        "tui.title.chat": "对话",
        "tui.title.task_info": "任务信息",
        "tui.title.workflow": "工作流",
        "tui.title.trace": "Trace",
        "tui.title.trace_mouse": "Trace（点击跳转至开头）",
        "tui.title.trace_nomouse": "Trace",
        ...
        "tui.placeholder.input_disabled": "任务执行中（输入已禁用，Ctrl+C 取消）...",
        "tui.placeholder.input_only_main": "仅 main 可输入，请切回 {main}...",
        ...
        "tui.msg.workflow_cancel_request": "⚠️ 检测到 Ctrl+C，正在取消当前生成...",
        ...
        "tui.msg.input_only_main_warn": "仅 main 可输入，请切回 {main}",
        "tui.msg.clear_ok": "已清空主输出",
        "tui.msg.clear_ok_hint": "已清空主输出（子命令尚未实现，已执行默认 /clear）",
        ...
        "presenter.hint.other_tab_output": "已在其他任务标签输出：{label}",
        ...
        "summary.subagents.round_summary": "轮次汇总",
        "summary.subagents.task_detail": "任务明细",
        "summary.subagents.error_brief": "error(摘要)",
    ...
    "en": {
        ...
        "theme.light": "Light",
        # ===== TUI: bindings =====
        "tui.binding.cancel_or_quit": "Cancel/quit",
        ...
        "tui.binding.copy_job_id": "Copy task ID",
        ...
        "tui.binding.toggle_mouse": "Toggle mouse mode",
        "tui.binding.mouse_on": "Enable mouse mode",
        "tui.binding.mouse_off": "Disable mouse mode",
        "tui.msg.mouse_enabled": "Mouse interaction: on",
        "tui.msg.mouse_disabled": "Native selection: on (mouse off)",
        "tui.msg.mouse_toggle_failed": "Toggle mouse mode failed",
        # ===== TUI: titles / placeholders =====
        "tui.title.tasks_bar": "Tasks",
        "tui.title.tasks_bar_mouse": "Tasks (click / ←→ to switch)",
        "tui.title.tasks_bar_nomouse": "Tasks (←→ to switch)",
        "tui.title.chat": "Chat",
        "tui.title.task_info": "Task Info",
        "tui.title.workflow": "Workflow",
        "tui.title.trace": "Trace",
        "tui.title.trace_mouse": "Trace (click to jump to start)",
        "tui.title.trace_nomouse": "Trace",
        ...
        "tui.placeholder.input_disabled": "Running (input disabled, Ctrl+C to cancel)…",
        "tui.placeholder.input_only_main": "Only main accepts input. Switch back to {main}…",
        ...
        "tui.msg.workflow_cancel_request": "⚠️ Ctrl+C detected, cancelling current generation...",
        ...
        "tui.msg.input_only_main_warn": "Only main accepts input. Please switch back to {main}.",
        "tui.msg.clear_ok": "Main output cleared.",
        "tui.msg.clear_ok_hint": "Main output cleared (subcommand not implemented; default /clear applied).",
        ...
        "presenter.hint.other_tab_output": "Output is in another task tab: {label}",
        "presenter.hint.switch_watch": (
        ...
        # ===== Session notifications =====
        "session.notify.done_ok": "✅ AIKG task finished",
        "session.notify.done_fail": "❌ AIKG task finished",
        "session.notify.failed": "❌ AIKG task failed",
        ...
        "summary.row.subagent": "Sub-agent",
        ...
        "summary.subagents.round_summary": "round summary",
        "summary.subagents.task_detail": "tasks",
        "summary.subagents.error_brief": "error (brief)",
