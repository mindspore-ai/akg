...
@pytest.mark.asyncio
async def test_kernelbench_torch_tilelang_a100():
    """测试 KernelBench - PyTorch TileLang"""
    framework = "torch"
    dsl = "tilelang_cuda"
    backend = "cuda"
    arch = "a100"
    ...
    config = load_config(config_path="./python/ai_kernel_generator/config/vllm_tilelang_cuda_coderonly_config.yaml")
