...
@triton.autotune(configs=[
        triton.Config({'BLOCK_SIZE_M': 256, 'BLOCK_SIZE_N': 14}),
        triton.Config({'BLOCK_SIZE_M': 256, 'BLOCK_SIZE_N': 16}),
        triton.Config({'BLOCK_SIZE_M': 256, 'BLOCK_SIZE_N': 32}),
...
def sum_kernel(
    ...
    tl.store(output0_ptrs, col_sum, mask=nmask)
