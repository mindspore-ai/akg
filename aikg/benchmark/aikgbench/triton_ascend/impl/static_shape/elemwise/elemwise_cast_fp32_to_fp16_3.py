...
configs = [
    triton.Config({"BLOCK_SIZE":2097152, "TILE_SIZE": 32768}), # 32corenum，并行度低。
    triton.Config({"BLOCK_SIZE":2097152, "TILE_SIZE": 32768}), # 64corenum。性能最优。
    triton.Config({"BLOCK_SIZE":2097152, "TILE_SIZE": 16384}), # 64corenum，UB未用满。
]
@triton.autotune(
    configs=configs,
    key=['n_elements'],
