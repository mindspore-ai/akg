...
@triton.autotune(
    configs=[
        ...
        triton.Config({'NUM_BLOCKS': 96, 'SUB_M': 2}),
        triton.Config({'NUM_BLOCKS': 96, 'SUB_M': 4}),
        triton.Config({'NUM_BLOCKS': 128, 'SUB_M': 1}),
        triton.Config({'NUM_BLOCKS': 128, 'SUB_M': 2}),
        triton.Config({'NUM_BLOCKS': 128, 'SUB_M': 4}),
        triton.Config({'NUM_BLOCKS': 256, 'SUB_M': 1}),
        triton.Config({'NUM_BLOCKS': 256, 'SUB_M': 2}),
        triton.Config({'NUM_BLOCKS': 256, 'SUB_M': 4}),
        triton.Config({'NUM_BLOCKS': 120, 'SUB_M': 2}),
        triton.Config({'NUM_BLOCKS': 120, 'SUB_M': 4}),
        triton.Config({'NUM_BLOCKS': 120, 'SUB_M': 8}),
        triton.Config({'NUM_BLOCKS': 40, 'SUB_M': 1}),
        triton.Config({'NUM_BLOCKS': 40, 'SUB_M': 2}),
        triton.Config({'NUM_BLOCKS': 40, 'SUB_M': 4}),
        triton.Config({'NUM_BLOCKS': 40, 'SUB_M': 8}),
        triton.Config({'NUM_BLOCKS': 40, 'SUB_M': 16}),
    ],
    key=['M', 'N'],
)
@triton.jit
