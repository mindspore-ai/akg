...
class Model(nn.Module):
    ...
    def forward(self, var, var_scale=None, indices=None, updates=None, smooth_scales=None):
        ...
        # This is a reduction operation with no specific dimension (reduces all dimensions).
...
def get_inputs_dyn_list():
    # Sum reduction variation cases with both aligned and non-aligned shapes (all dimensions)
