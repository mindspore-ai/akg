...
class Model(nn.Module):
    ...
    def forward(self, var, var_scale=None, indices=None, updates=None, smooth_scales=None):
        ...
        return torch.argmax(var, dim=self.dim)


def get_inputs_dyn_list():
    # Argmax reduction along dimension 0 variation cases with both aligned and non-aligned shapes
...
def get_init_inputs():
    # Fixed parameters for argmax reduction along dimension 0
