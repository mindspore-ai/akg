...
def get_inputs_dyn_list():
    # Flash attention variation cases with both aligned and non-aligned shapes
    ...
    # Case 10: Extreme tensor size (32, 8, 511, 64) (non-aligned)
    query10 = torch.randn(32, 8, 511, 64, dtype=torch.float16)
    key10 = torch.randn(32, 8, 511, 64, dtype=torch.float16)
    value10 = torch.randn(32, 8, 511, 64, dtype=torch.float16)
