...
def get_inputs():
    # Using shapes that are representative of large model computations in transformer models with causal attention
    # Shape (16, 12, 512, 64) represents:
    # - 16 batches
    # - 12 attention heads
    # - 512 sequence length
    # - 64 head dimension
    batch, num_heads, seq_len, head_dim = 16, 12, 512, 64
