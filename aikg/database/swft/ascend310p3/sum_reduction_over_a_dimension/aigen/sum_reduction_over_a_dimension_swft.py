...
def sum_reduction_over_a_dimension_impl_npu(gm_input, gm_output):
...
def sum_reduction_over_a_dimension_host_run():
    set_context("310P")
    ...
    sum_reduction_over_a_dimension_impl_npu(gm_input, gm_output)
