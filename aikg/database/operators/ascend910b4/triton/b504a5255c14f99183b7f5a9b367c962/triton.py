...
@triton.jit
def standard_matrix_multiplication__kernel(
    a_ptr, b_ptr, c_ptr,
    M, N, K,
    stride_am, stride_ak,
    stride_bk, stride_bn,
...
def standard_matrix_multiplication__triton_torch(A: torch.Tensor, B: torch.Tensor):
    """
    ...
    # Launch kernel
    standard_matrix_multiplication__kernel[grid](
        A, B, C, 
        M, N, K,
