...
.claude/settings.json; users do not invoke them directly. Each hook is a
thin dispatcher: parse the tool I/O, consult phase_machine, emit a
{decision, reason} JSON or guidance message, exit 0.
