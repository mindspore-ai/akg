...
def swiglu_quant_op_impl_npu(gm_x, gm_smooth_scales, gm_output, gm_scale, gm_swiglu_out, dim0):
    BLOCK_DIM = 8
    N = 256
    ...
    for iter_idx in dynamic_loop(per_core_rows):
        ...
        # round_fp32_to_int8
        q_tile_half = vconv(q_brcb_mul, "FP16")
...
def swiglu_quant_op_host_run():
    ...
    dim0 = Scalar("INT32")
    swiglu_quant_op_impl_npu(gm_x, gm_smooth_scales, gm_output, gm_scale, gm_swiglu_out, dim0)
