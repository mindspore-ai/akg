...
@pytest.mark.use_model
@pytest.mark.asyncio
async def test_akg_kernels_bench_torch_tilelang_ascend910b4():
    """测试 AIKGBench - PyTorch TileLang Ascend910B4"""
    framework = "torch"
    dsl = "tilelang_ascend"
    backend = "ascend"
    arch = "ascend910b4"
...
@pytest.mark.use_model
@pytest.mark.asyncio
async def test_evokernel_mhc_torch_tilelang_ascend910b4():
    """测试 EvoKernel MHC - PyTorch TileLang Ascend910B4"""
    framework = "torch"
    dsl = "tilelang_ascend"
    backend = "ascend"
    arch = "ascend910b4"
