...
Install RAG-related dependencies by running the following command in the `akg_agents` directory:
...
This command downloads the `text2vec-large-chinese` model to `~/.akg_agents/text2vec-large-chinese`.
...
- To re-download, delete the `~/.akg_agents/text2vec-large-chinese` directory first
