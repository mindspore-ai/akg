# KernelBench 不同 DSL 算子生成成功率报告

## 概述

本报告在 **KernelBench** 基准上，按 DSL 分列维护算子生成成功率。

- ✓ 生成成功 · ✗ 生成失败

## DSL 更新记录

| DSL | 后端 | 测试方法 | 成功率 | 更新时间 |
|-----|------|----------|--------|----------|
| PyPTO | Ascend `ascend910b3` | adaptive search，10 次提交 | 56/100 (56%) | 2026-06-05 |
...
| 序号 | 算子名称 | PyPTO (2026-06-05) | TileLang_Ascend (2026-06-05) |
|------|----------|-------|-------|
