# KernelBench Multi-DSL Kernel Generation Success Rate Report

## Overview

This report tracks operator generation success on **KernelBench**, with one column per DSL.

- ✓ = succeeded · ✗ = failed

## DSL Update Log

| DSL | Backend | Method | Success Rate | Last Updated |
|-----|---------|--------|--------------|--------------|
| PyPTO | Ascend `ascend910b3` | adaptive search, 10 submissions | 56/100 (56%) | 2026-06-05 |
| TileLang_Ascend | Ascend `ascend910b4` | pass@4 | 49/100 (49%) | 2026-06-05 |

## Success Rate Statistics

- **PyPTO** (2026-06-05): 56/100 (56%)
- **TileLang_Ascend** (2026-06-05): 49/100 (49%)

## Detailed Results

| No. | Kernel Name | PyPTO (2026-06-05) | TileLang_Ascend (2026-06-05) |
|-----|-------------|-------|-------|
