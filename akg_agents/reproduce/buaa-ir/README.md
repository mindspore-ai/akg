...
同时，增加了元提示文档扩充方式，通过在 config 文件（例如：triton_cuda_evolve_config.yaml）中添加对应的元提示文档目录路径，即可加载自定义元提示。具体自定义元提示案例可参考 op/resources/custom_meta_prompts/example_strategy.yaml。
