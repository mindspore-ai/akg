...
def get_inputs():
    # Using shapes that are representative of large model computations in transformer models with dropout
    # Shape (8, 16, 256, 128) represents:
    # - 8 batches
    # - 16 attention heads
    # - 256 sequence length
    # - 128 head dimension
    batch, num_heads, seq_len, head_dim = 8, 16, 256, 128
