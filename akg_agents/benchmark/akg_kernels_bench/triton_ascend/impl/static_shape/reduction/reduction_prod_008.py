...
@triton.autotune(configs=[
        triton.Config({'BLOCK_SIZE_M': 16384, 'BLOCK_SIZE_N': 1}),
        triton.Config({'BLOCK_SIZE_M': 8192, 'BLOCK_SIZE_N': 2}),
        triton.Config({'BLOCK_SIZE_M': 4096, 'BLOCK_SIZE_N': 4}),
        triton.Config({'BLOCK_SIZE_M': 2048, 'BLOCK_SIZE_N': 8}),
