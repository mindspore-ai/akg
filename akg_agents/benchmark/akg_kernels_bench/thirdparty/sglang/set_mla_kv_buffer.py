...
# Triton Kernel:
#   set_mla_kv_buffer_kernel - 将nope和rope部分写入MLA KV缓冲区
# ============================================================================
...
def get_inputs():
    ...
    cache_k_nope = torch.randn(n_loc, nope_dim, dtype=dtype)
    cache_k_rope = torch.randn(n_loc, rope_dim, dtype=dtype)
