...
from akg_agents.op.utils.evolve.runner_manager import (
    RunnerConfig,
...
from akg_agents.op.cann_correctness import is_cann_task_dir, load_cann_task_for_runner
...
def parse_batch_runner_mode(args):
    ...
    # 
    # 两种模式：
    # 1. 远程模式：设置 AKG_AGENTS_WORKER_URL，连接远程 Worker 服务
    #    - device 参数被忽略，远程服务统一管理设备
    # 
    # 2. 本地模式：不设置 AKG_AGENTS_WORKER_URL
