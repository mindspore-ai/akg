...
def patch_tilelang_compiler():
    ...
    # 检查是否已经被补丁过了
    if hasattr(compiler_class._npuir_to_bin_enable_npu_compile, '_akg_agents_patched'):
        return True
    ...
    try:
        ...
        # 标记已经被补丁过了
        compiler_class._npuir_to_bin_enable_npu_compile._akg_agents_patched = True
        return True
