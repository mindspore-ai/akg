...
def load_meta_prompts(dsl: str, parallel_num: int) -> List[str]:
    ...
    try:
        ...
        if dsl == "triton_ascend":
            from akg_agents.op.resources.docs.triton_ascend_docs.meta_prompts import (
                triton_meta_prompts,
            )
            ...
            # from akg_agents.op.resources.docs.swft_docs.meta_prompts import swft_meta_prompts
