# Ascend950PR_958b NPU 硬件规格

## 1. 硬件架构

**芯片配置**
- 32 个 AI Core，每个包含: 2 个 VEC（向量计算单元） + 1 个 CUBE（矩阵计算单元）
- 整个芯片: 64个 VEC, 32个 CUBE
...
|---------|------|---------|------|------|
| GM | 112GB | 全设备 | - | 设备主存储 |
| L2 Cache | 112MB | 32 个 AI Core | - | 自动缓存 |
...
**性能:** 1拍处理 2 × 128 Bytes向量计算 (每AI Core有2个VEC)，频率1650MHz
...
**性能:** 1拍完成 16×16×16 FP16矩阵乘 (8192 FLOPs/cycle)，频率1650MHz
...
**并行:** 32个AI Core按需并行分配任务，CUBE与VEC可同时执行不同任务
