...
class ConvertMuseAclnnAdd : public mlir::OpConversionPattern<mlir::muse::AclnnAddOp> {
 public:
  using OpConversionPattern::OpConversionPattern;

  mlir::LogicalResult matchAndRewrite(mlir::muse::AclnnAddOp op, OpAdaptor adaptor,
...
void populateMuseAclnnToTorchConversionPatterns(TypeConverter &converter, RewritePatternSet &patterns) {
  MLIRContext *context = patterns.getContext();
  patterns.add<ConvertMuseAclnnAdd>(converter, context);
}
