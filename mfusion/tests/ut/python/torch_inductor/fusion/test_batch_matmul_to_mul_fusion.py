...
os.environ['LLVM_DEBUG'] = 'fuse-matmul-k1-to-mul'

# Test case 1: Matmul with k=1 (f32)
MLIR_MATMUL_TO_MUL_F32 = r"""
module {
  func.func @main(%arg0: !torch.vtensor<[3, 1],f32>, %arg1: !torch.vtensor<[1, 4],f32>)
      -> !torch.vtensor<[3, 4],f32> attributes {torch.assume_strict_symbolic_shapes} {
    %0 = torch.aten.mm %arg0, %arg1 : !torch.vtensor<[3, 1],f32>, !torch.vtensor<[1, 4],f32>
...
module {
  func.func @main(%arg0: !torch.vtensor<[1, 3],bf16>, %arg1: !torch.vtensor<[1, 4],bf16>)
      -> !torch.vtensor<[3, 4],bf16> attributes {torch.assume_strict_symbolic_shapes} {
    %int0 = torch.constant.int 0
    %int1 = torch.constant.int 1
    %0 = torch.aten.transpose.int %arg0, %int0, %int1
        : !torch.vtensor<[1, 3],bf16>, !torch.int, !torch.int -> !torch.vtensor<[3, 1],bf16>
    %1 = torch.aten.mm %0, %arg1 : !torch.vtensor<[3, 1],bf16>, !torch.vtensor<[1, 4],bf16>
        -> !torch.vtensor<[3, 4],bf16>
...
module {
  func.func @main(%arg0: !torch.vtensor<[3, 1],f16>, %arg1: !torch.vtensor<[1, 4],f16>)
      -> !torch.vtensor<[3, 4],f16> attributes {torch.assume_strict_symbolic_shapes} {
    %0 = torch.aten.mm %arg0, %arg1 : !torch.vtensor<[3, 1],f16>, !torch.vtensor<[1, 4],f16>
        -> !torch.vtensor<[3, 4],f16>
...
module {
  func.func @main(%arg0: !torch.vtensor<[1, 3],bf16>, %arg1: !torch.vtensor<[4, 1],bf16>)
      -> !torch.vtensor<[3, 4],bf16> attributes {torch.assume_strict_symbolic_shapes} {
    %int0 = torch.constant.int 0
    %int1 = torch.constant.int 1
    %0 = torch.aten.transpose.int %arg0, %int0, %int1
        : !torch.vtensor<[1, 3],bf16>, !torch.int, !torch.int -> !torch.vtensor<[3, 1],bf16>
    %1 = torch.aten.transpose.int %arg1, %int0, %int1
        : !torch.vtensor<[4, 1],bf16>, !torch.int, !torch.int -> !torch.vtensor<[1, 4],bf16>
    %2 = torch.aten.mm %0, %1 : !torch.vtensor<[3, 1],bf16>, !torch.vtensor<[1, 4],bf16>
        -> !torch.vtensor<[3, 4],bf16>
...
# Guards fuse-matmul-k1-to-mul when input rank > 2 (k dimension uses last-two indices).
MLIR_BATCH_MATMUL_RANK3_K1_TO_MUL = r"""
module {
  func.func @main(%arg0: !torch.vtensor<[2, 3, 1],f32>, %arg1: !torch.vtensor<[2, 1, 4],f32>)
      -> !torch.vtensor<[2, 3, 4],f32> attributes {torch.assume_strict_symbolic_shapes} {
    %0 = torch.aten.bmm %arg0, %arg1 : !torch.vtensor<[2, 3, 1],f32>, !torch.vtensor<[2, 1, 4],f32>
...
def test_matmul_to_mul_fusion_f32():
    ...
    assert checker.check_has_op("torch.aten.mul.Tensor"), (
        checker.error or "torch.aten.mul.Tensor should exist after fusion"
    )
