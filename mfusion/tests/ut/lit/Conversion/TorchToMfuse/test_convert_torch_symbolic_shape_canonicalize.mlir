...
module {
  ...
  // CHECK-DAG: %[[C0:.*]] = builtin.unrealized_conversion_cast %arg0 : !torch.vtensor<[1,1,?,37],f32> to tensor<1x1x6x37xf32>
  // CHECK-DAG: %[[C1:.*]] = builtin.unrealized_conversion_cast %arg1 : !torch.vtensor<[1,1,?,37],f32> to tensor<1x1x6x37xf32>
  ...
  // CHECK-NOT: torch.bind_symbolic_shape
  // CHECK-DAG: %[[CS0:.*]] = builtin.unrealized_conversion_cast %arg0 : !torch.vtensor<[1,1,?,37],f32> to tensor<1x1x6x37xf32>
  // CHECK-DAG: %[[CS1:.*]] = builtin.unrealized_conversion_cast %arg1 : !torch.vtensor<[1,1,?,37],f32> to tensor<1x1x6x37xf32>
