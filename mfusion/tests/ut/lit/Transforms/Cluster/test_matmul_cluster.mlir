...
func.func @test_matmul_cluster(%arg0: tensor<128x256xf16>, %arg1: tensor<256x512xf16>) -> tensor<128x512xf16> {
  ...
  %0 = mfuse.matmul %arg0, %arg1 : (tensor<128x256xf16>, tensor<256x512xf16>) -> tensor<128x512xf16>
  // Add operation with matmul result
  %1 = mfuse.add %0, %0 : (tensor<128x512xf16>, tensor<128x512xf16>) -> tensor<128x512xf16>
...
// CHECK: %[[BMM:.*]] = mfuse.batch_matmul %[[ARG2]], %[[ARG3]]
...
func.func @test_batch_matmul_cluster(%arg0: tensor<2x128x256xf16>, %arg1: tensor<2x256x512xf16>) -> tensor<2x128x512xf16> {
  ...
  %0 = mfuse.batch_matmul %arg0, %arg1 : (tensor<2x128x256xf16>, tensor<2x256x512xf16>) -> tensor<2x128x512xf16>
  // Add operation
...
func.func @test_batch_matmul_transpose_a(%arg0: tensor<2x256x128xf16>, %arg1: tensor<2x256x512xf16>) -> tensor<2x128x512xf16> {
  ...
  %0 = mfuse.batch_matmul %arg0, %arg1 {transpose_a = true} : (tensor<2x256x128xf16>, tensor<2x256x512xf16>) -> tensor<2x128x512xf16>
  // Add operation
  %1 = mfuse.add %0, %0 : (tensor<2x128x512xf16>, tensor<2x128x512xf16>) -> tensor<2x128x512xf16>
  return %1 : tensor<2x128x512xf16>
}
...
func.func @test_batch_matmul_transpose_b(%arg0: tensor<2x128x256xf16>, %arg1: tensor<2x512x256xf16>) -> tensor<2x128x512xf16> {
  ...
  %0 = mfuse.batch_matmul %arg0, %arg1 {transpose_b = true} : (tensor<2x128x256xf16>, tensor<2x512x256xf16>) -> tensor<2x128x512xf16>
  // Add operation
  %1 = mfuse.add %0, %0 : (tensor<2x128x512xf16>, tensor<2x128x512xf16>) -> tensor<2x128x512xf16>
  return %1 : tensor<2x128x512xf16>
}
...
func.func @test_batch_matmul_transpose_both(%arg0: tensor<2x256x128xf16>, %arg1: tensor<2x512x256xf16>) -> tensor<2x128x512xf16> {
  ...
  %0 = mfuse.batch_matmul %arg0, %arg1 {transpose_a = true, transpose_b = true} : (tensor<2x256x128xf16>, tensor<2x512x256xf16>) -> tensor<2x128x512xf16>
  // Add operation
  %1 = mfuse.add %0, %0 : (tensor<2x128x512xf16>, tensor<2x128x512xf16>) -> tensor<2x128x512xf16>
  return %1 : tensor<2x128x512xf16>
}
