...
module {
  ...
  func.func @test_layer_norm_fusion(%x: tensor<4x197x384xf32>, %gamma: tensor<384xf32>, %beta: tensor<384xf32>)
    ...
    %eps = mfuse.constant dense<1.000000e-05> : tensor<f64, {is_scalar = ""}>
    %var_plus_eps = mfuse.add %variance, %eps : (tensor<4x197x384xf32>, tensor<f64, {is_scalar = ""}>) -> tensor<4x197x384xf32>
  ...
  func.func @test_layer_norm_fusion_all_dims(%x: tensor<384xf32>, %gamma: tensor<384xf32>, %beta: tensor<384xf32>)
    ...
    %eps = mfuse.constant dense<1.000000e-05> : tensor<f64, {is_scalar = ""}>
    %var_plus_eps = mfuse.add %variance, %eps : (tensor<384xf32>, tensor<f64, {is_scalar = ""}>) -> tensor<384xf32>
  ...
  func.func @test_layer_norm_no_fusion_keepdim_false(%x: tensor<4x197x384xf32>, %gamma: tensor<384xf32>, %beta: tensor<384xf32>)
    ...
    %eps = mfuse.constant dense<1.000000e-05> : tensor<f64, {is_scalar = ""}>
    %var_plus_eps = mfuse.add %variance, %eps : (tensor<4x197xf32>, tensor<f64, {is_scalar = ""}>) -> tensor<4x197xf32>
