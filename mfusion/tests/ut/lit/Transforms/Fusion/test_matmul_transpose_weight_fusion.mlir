...
module {
  ...
  func.func @transpose_weight_one_input(%arg0: tensor<2x100xf32>, %arg1: tensor<100x8xf32>) -> tensor<2x8xf32> {
    %0 = mfuse.matmul %arg0, %arg1 : (tensor<2x100xf32>, tensor<100x8xf32>) -> tensor<2x8xf32>
  ...
  func.func @transpose_weight_both_inputs(%arg0: tensor<2x100xf32>, %arg1: tensor<100x100xf32>) -> tensor<2x100xf32> {
    %0 = mfuse.matmul %arg0, %arg1 : (tensor<2x100xf32>, tensor<100x100xf32>) -> tensor<2x100xf32>
  ...
  func.func @transpose_weight_mm_with_bias(%arg0: tensor<2x100xf32>, %arg1: tensor<100x8xf32>, %arg2: tensor<8xf32>) -> tensor<2x8xf32> {
    %0 = mfuse.matmul_with_bias %arg0, %arg1, %arg2 : (tensor<2x100xf32>, tensor<100x8xf32>, tensor<8xf32>) -> tensor<2x8xf32>
    // CHECK: mfuse.permute
    // CHECK: mfuse.permute
    // CHECK: mfuse.matmul_with_bias {{.*}} {trans_x1 = true, trans_x2 = true}
    return %0 : tensor<2x8xf32>
  }
}
