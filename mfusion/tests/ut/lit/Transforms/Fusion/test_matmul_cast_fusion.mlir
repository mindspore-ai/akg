...
module {
  ...
  func.func @matmul_cast_fuse(%arg0: tensor<2x4xf16>, %arg1: tensor<4x8xf16>) -> tensor<2x8xf32> {
    ...
    %1 = mfuse.cast %0 {dtype = f32} : (tensor<2x8xf16>) -> tensor<2x8xf32>
    // After fusion: matmul + cast replaced by single matmul with f32 result
    // CHECK-NOT: mfuse.cast
    // CHECK: %[[R:.*]] = mfuse.matmul %[[A]], %[[B]] : (tensor<2x4xf16>, tensor<4x8xf16>) -> tensor<2x8xf32>
    // CHECK: return %[[R]]
  ...
  func.func @mm_with_bias_cast_fuse(%arg0: tensor<2x4xf16>, %arg1: tensor<4x8xf16>, %arg2: tensor<8xf16>) -> tensor<2x8xf32> {
    %0 = mfuse.matmul_with_bias %arg0, %arg1, %arg2 : (tensor<2x4xf16>, tensor<4x8xf16>, tensor<8xf16>) -> tensor<2x8xf16>
    %1 = mfuse.cast %0 {dtype = f32} : (tensor<2x8xf16>) -> tensor<2x8xf32>
    // CHECK-NOT: mfuse.cast
