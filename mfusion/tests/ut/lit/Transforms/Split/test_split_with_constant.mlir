...
func.func @test_split_with_scalar_constant(%arg0: tensor<4x4xf32>) -> tensor<4x4xf32> {
  ...
  ^bb0(%arg1: tensor<4x4xf32>):
    ...
    %1 = mfuse.mul %arg1, %cst : (tensor<4x4xf32>, tensor<f32>) -> tensor<4x4xf32>
...
func.func @test_split_with_bool_constant(%arg0: tensor<4x4xf32>, %arg1: tensor<4x4xf32>) -> tensor<4x4xf32> {
  ...
  ^bb0(%arg2: tensor<4x4xf32>, %arg3: tensor<4x4xf32>):
    ...
    %2 = mfuse.select %cst, %arg2, %arg3 : (tensor<i1>, tensor<4x4xf32>, tensor<4x4xf32>) -> tensor<4x4xf32>
    mfuse.yield %2 : tensor<4x4xf32>
  }
  return %0 : tensor<4x4xf32>
}
...
// CHECK-SAME: %arg0: tensor<4x4xf32>
// CHECK: %[[CST:.*]] = arith.constant dense<0x7F800000> : tensor<f32>
...
func.func @test_split_with_multiple_constants(%arg0: tensor<4x4xf32>, %arg1: tensor<4x4xf32>) -> tensor<4x4xf32> {
  ...
  ^bb0(%arg2: tensor<4x4xf32>):
    %cst = arith.constant dense<2.000000e+00> : tensor<f32>
    %cst_0 = arith.constant dense<3.000000e+00> : tensor<f32>
    %1 = mfuse.mul %arg2, %cst : (tensor<4x4xf32>, tensor<f32>) -> tensor<4x4xf32>
    %2 = mfuse.add %1, %cst_0 : (tensor<4x4xf32>, tensor<f32>) -> tensor<4x4xf32>
    mfuse.yield %2 : tensor<4x4xf32>
  }
  return %0 : tensor<4x4xf32>
}
