...
from tvm.hybrid.intrin import (IntrinDef, _patch_intrins_to_calls,
                     _unpatch_intrins_from_calls, _patch_intrins_to_runtime,
                     _unpatch_intrins_from_runtime, decl_tensor_intrin)
from .parser import source_to_op
from .util import (_internal_assert, _internal_assert_arg_type, _AssertCallable,
                   _pruned_source)


def script(pyfunc=None, intrinsics=None, capture=None):
