...
.set_attr<FTVMCompute>(
  "FTVMCompute", [](const NodeAttrs& attrs,
    ...
    Expr fill_value = air::make_const(dtype, param.fill_value);
...
.set_attr<FTVMCompute>(
  "FTVMCompute", [](const NodeAttrs& attrs,
    ...
    Array<Expr> shape = ShapeToArray(param.shape);
    Type dtype = GetTVMType(param.dtype);
    Expr fill_value = air::make_const(dtype, 0);
    return Array<Tensor>{ topi::full(shape, dtype, fill_value) };
})
.set_support_level(4);
...
.set_attr<FTVMCompute>(
  "FTVMCompute", [](const NodeAttrs& attrs,
    ...
    Array<Expr> shape = ShapeToArray(param.shape);
    Type dtype = GetTVMType(param.dtype);
    Expr fill_value = air::make_const(dtype, 1);
    return Array<Tensor>{ topi::full(shape, dtype, fill_value) };
})
.set_support_level(4);
...
.set_attr<FTVMCompute>(
    "FTVMCompute", [](const NodeAttrs& attrs,
      ...
      const Expr fill_value = air::make_const(out_info[0]->dtype, param.fill_value);
...
.set_attr<FTVMCompute>(
    "FTVMCompute", [](const NodeAttrs& attrs,
      ...
      return Array<Tensor> { topi::full_like(inputs[0],
                                             air::make_const(out_info[0]->dtype, 0)) };
})
.set_support_level(4);
...
.set_attr<FTVMCompute>(
    "FTVMCompute", [](const NodeAttrs& attrs,
                      ...
                      const Array<Tensor>& out_info) {
      return Array<Tensor> { topi::full_like(inputs[0],
                                             air::make_const(out_info[0]->dtype, 1)) };
})
.set_support_level(4);
...
.set_attr<FTVMCompute>(
  "FTVMCompute", [](const NodeAttrs& attrs,
                    ...
                    const Array<Tensor>& out_info) {
    return Array<Tensor>{ binary_scalar_op(attrs, inputs[0],
      [](Expr x, Expr y) { return air::pow(x, y); }) };
})
.set_attr<FGradient>(
  "FGradient", [](const NodePtr& n,
                  const std::vector<NodeEntry>& ograds){
...
.set_attr<FTVMCompute>(
  "FTVMCompute", [](const NodeAttrs& attrs,
                    ...
                    const Array<Tensor>& out_info) {
    return Array<Tensor>{ binary_scalar_op(attrs, inputs[0],
      [](Expr x, Expr y) { return air::pow(y, x); }) };
})
.set_attr<FGradient>(
  "FGradient", [](const NodePtr& n,
                  const std::vector<NodeEntry>& ograds){
...
.set_attr<FTVMCompute>(
  "FTVMCompute", [](const NodeAttrs& attrs,
    ...
    return Array<Tensor>{
      topi::clip(inputs[0], air::make_const(air::Float(32), params.a_min),
                 air::make_const(air::Float(32), params.a_max)) };
  })
