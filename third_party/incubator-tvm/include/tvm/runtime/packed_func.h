...
class TVMArgValue : public TVMPODValue_ {
 public:
  ...
  inline operator air::DataType() const;
  inline operator air::Expr() const;
  inline operator air::Integer() const;
};
...
class TVMRetValue : public TVMPODValue_ {
 public:
  ...
  // type related
  inline operator air::DataType() const;
  inline TVMRetValue& operator=(const air::DataType& other);
...
class TVMArgsSetter {
 public:
  ...
  inline void operator()(size_t i, const air::DataType& t) const;
