...
#define RELAY_DEFINE_NODE_REF(TypeName, NodeName, NodeRefBase)          \
  class TypeName : public NodeRefBase {                                 \
   public:                                                              \
    TypeName() {}                                                       \
    explicit TypeName(::air::ObjectPtr<::air::Object> n)                \
        : NodeRefBase(n) {                                              \
    }                                                                   \
