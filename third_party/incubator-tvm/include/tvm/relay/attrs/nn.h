 ...
 */
struct BiasAddAttrs : public air::AttrsNode<BiasAddAttrs> {
  int axis;
...
struct Conv2DAttrs : public air::AttrsNode<Conv2DAttrs> {
...
struct Conv2DWinogradWeightTransformAttrs :
    public air::AttrsNode<Conv2DWinogradWeightTransformAttrs> {
  int tile_size;
...
struct Conv2DWinogradAttrs : public air::AttrsNode<Conv2DWinogradAttrs> {
  int tile_size;
  Array<IndexExpr> strides;
  Array<IndexExpr> padding;
  Array<IndexExpr> dilation;
...
struct Conv2DWinogradNNPACKWeightTransformAttrs
    : public air::AttrsNode<Conv2DWinogradNNPACKWeightTransformAttrs> {
...
struct SoftmaxAttrs : public air::AttrsNode<SoftmaxAttrs> {
  int axis;
...
struct Conv2DTransposeAttrs : public air::AttrsNode<Conv2DTransposeAttrs> {
  IndexExpr channels;
  Array<IndexExpr> kernel_size;
  Array<IndexExpr> strides;
  Array<IndexExpr> padding;
...
struct MaxPool2DAttrs : public air::AttrsNode<MaxPool2DAttrs> {
...
struct AvgPool2DAttrs : public air::AttrsNode<AvgPool2DAttrs> {
  Array<IndexExpr> pool_size;
  Array<IndexExpr> strides;
  Array<IndexExpr> padding;
  std::string layout;
...
struct GlobalPool2DAttrs : public air::AttrsNode<GlobalPool2DAttrs> {
  std::string layout;
...
struct AdaptivePool2DAttrs : public air::AttrsNode<AdaptivePool2DAttrs> {
...
struct DenseAttrs : public air::AttrsNode<DenseAttrs> {
  IndexExpr units;
  DataType out_dtype;
...
struct UpSamplingAttrs : public air::AttrsNode<UpSamplingAttrs> {
  double scale_h;
  double scale_w;
  std::string layout;
  std::string method;
...
struct PadAttrs : public air::AttrsNode<PadAttrs> {
  double pad_value;
...
struct MirrorPadAttrs : public air::AttrsNode<MirrorPadAttrs> {
  std::string mode;
  Array<Array<IndexExpr> > pad_width;
...
struct LeakyReluAttrs : public air::AttrsNode<LeakyReluAttrs> {
  double alpha;
...
struct PReluAttrs : public air::AttrsNode<PReluAttrs> {
  int axis;
...
struct DropoutAttrs : public air::AttrsNode<DropoutAttrs> {
  double rate;
...
struct BatchNormAttrs : public air::AttrsNode<BatchNormAttrs> {
  int axis;
  double epsilon;
  bool center;
  bool scale;
...
struct InstanceNormAttrs : public air::AttrsNode<InstanceNormAttrs> {
  int axis;
  double epsilon;
  bool center;
  bool scale;
...
struct LayerNormAttrs : public air::AttrsNode<LayerNormAttrs> {
  int axis;
  double epsilon;
  bool center;
  bool scale;
...
struct LRNAttrs : public air::AttrsNode<LRNAttrs> {
  int size;
  int axis;
  double bias;
  double alpha;
...
struct L2NormalizeAttrs : public air::AttrsNode<L2NormalizeAttrs> {
  double eps;
  Array<Integer> axis;
...
struct DeformableConv2DAttrs : public air::AttrsNode<DeformableConv2DAttrs> {
  Array<IndexExpr> strides;
  Array<IndexExpr> padding;
  Array<IndexExpr> dilation;
