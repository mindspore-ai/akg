...
struct BitPackAttrs : public air::AttrsNode<BitPackAttrs> {
  int bits;
  int pack_axis;
  int bit_axis;
  DataType pack_type;
...
struct BinaryConv2DAttrs : public air::AttrsNode<BinaryConv2DAttrs> {
...
struct BinaryDenseAttrs : public air::AttrsNode<BinaryDenseAttrs> {
  IndexExpr units;
  int data_bits;
  int weight_bits;
  DataType pack_dtype;
