...
/*
 * 2019.12.30 - Define new type of binary operation:/ and %.
 */
...
namespace std {
template <>
struct hash<::air::Operation> : public ::air::NodeHash {
};

template <>
struct hash<::air::Tensor> {
  std::size_t operator()(const ::air::Tensor& k) const {
    ::air::NodeHash hasher;
