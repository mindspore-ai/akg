...
class Target : public NodeRef {
  ...
  */
   ...
   */
  TVM_DLL static air::Target Current(bool allow_not_defined = true);
 ...
 */
class BuildConfig : public ::air::NodeRef {
 public:
  BuildConfig() {}
...
#define TVM_GENERIC_FUNC_REG_VAR_DEF                            \
  static TVM_ATTRIBUTE_UNUSED ::air::GenericFunc& __mk_ ## TVM
