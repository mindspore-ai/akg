...
void Verify(air::runtime::Module mod, std::string fname) {
  // Get the function from the module.
  air::runtime::PackedFunc f = mod.GetFunction(fname);
  CHECK(f != nullptr);
...
int main(void) {
  ...
  air::runtime::Module mod_dylib =
      air::runtime::Module::LoadFromFile("lib/test_addone_dll.so");
  ...
  air::runtime::Module mod_syslib = (*air::runtime::Registry::Get("module._GetSystemLib"))();
