...
/*
 * 2019.12.30 - Modify the value false to true in the function Update.
 * 2020.04.16 - Fix div/floordiv infer bound error.
 */
...
class ConstIntBoundAnalyzer::Impl :
 ...
 public:
  ...
  Entry VisitExpr_(const Div* op) final {
    ...
    if (!((b.min_value >= 0 && b.max_value >= 0) || (b.min_value <= 0 && b.max_value <= 0))) {
      b.min_value = -1;
      b.max_value = 1;
    }
