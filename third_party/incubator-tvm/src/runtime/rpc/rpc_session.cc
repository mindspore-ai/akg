...
void RPCGetGlobalFunc(TVMArgs args, TVMRetValue* rv) {
  ...
  auto *fp = air::runtime::Registry::Get(name);
  if (fp != nullptr) {
    *rv = static_cast<void*>(new air::runtime::PackedFunc(*fp));
  } else {
    *rv = nullptr;
  }
}
