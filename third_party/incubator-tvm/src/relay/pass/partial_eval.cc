 ...
 */
struct WithFuncIdAttrs : public air::AttrsNode<WithFuncIdAttrs> {
  FuncId fid;
 ...
 public:
  ...
  Func VisitFuncStatic(const Function& func, const Expr& var) {
    ...
    return [=](const PStatic& self,
               ...
               const Attrs& attrs,
               const air::Array<Type>& type_args,
               LetList* ll) {
